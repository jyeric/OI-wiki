...
- 现在考虑 $i \le r$ 的情况。我们将尝试从已计算过的 $d_1[]$ 的值中获取一些信息。首先在子回文串 $(l, r)$ 中反转位置 $i$，即我们得到 $j = l + (r - i)$。现在来考察值 $d_1[j]$。因为位置 $j$ 同位置 $i$ 对称，我们 **几乎总是** 可以置 $d_1[i] = d_1[j]$。该想法的图示如下（可认为以 $j$ 为中心的回文串被「拷贝」至以 $i$ 为中心的位置上）：
  ...
  \ldots  
  \underbrace{
  s*{i-d_1[j]+1}\ \ldots\ s_i\ \ldots\ s_{i+d_1[j]-1}
  }_\text{palindrome}  
  \ldots\ s_r
  }^\text{palindrome}  
  \ldots
...
- [UVa #11475 "Extend to Palindrome"](https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=2470)<sup>[[存档](https://web.archive.org/web/20220707205931/https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=2470)]</sup>
- [「国家集训队」最长双回文串](https://www.luogu.com.cn/problem/P4555)<sup>[[存档](https://web.archive.org/web/20231010044710/https://www.luogu.com.cn/problem/P4555)]</sup>
- [CF1326D2. Labyrinth](https://codeforces.com/contest/1326/problem/D2)<sup>[[存档](https://web.archive.org/web/20220905054252/https://codeforces.com/contest/1326/problem/D2)]</sup>

***


**本页面主要译自博文 [Нахождение всех подпалиндромов](http://e-maxx.ru/algo/palindromes_count)<sup>[[存档](https://web.archive.org/web/20221205150355/http://e-maxx.ru/algo/palindromes_count)]</sup> 与其英文翻译版 [Finding all sub-palindromes in $O(N)$](https://cp-algorithms.com/string/manacher.html)<sup>[[存档](https://web.archive.org/web/20231217170150/https://cp-algorithms.com/string/manacher.html)]</sup>。其中俄文版版权协议为 Public Domain + Leave a Link；英文版版权协议为 CC-BY-SA 4.0。**
