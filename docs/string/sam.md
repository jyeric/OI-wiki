...
字符串 $s$ 的 SAM 是一个接受 $s$ 的所有后缀的最小 [DFA](../misc/fsm.md#%E7%A1%AE%E5%AE%9A%E6%80%A7%E6%9C%89%E9%99%90%E7%8A%B6%E6%80%81%E8%87%AA%E5%8A%A8%E6%9C%BA)。
...
在我们描述线性时间内构造 SAM 的算法之前，我们需要引入两个对理解构造过程非常重要的概念，并对其性质进行简单证明。其中，结束位置 $\operatorname{endpos}$ 定义了 SAM 中的结点（亦即指出了结点可以合并的充要条件），而后缀链接 $\operatorname{link}$ 不过是 AC 自动机中的 [失配指针](./ac-automaton.md#%E5%A4%B1%E9%85%8D%E6%8C%87%E9%92%88) 在 SAM 中的自然对应。
...
暂且接受这个事实，我们将基于它介绍构造 SAM 的算法。我们还将说明，SAM 需要满足的所有性质，除了最小性以外都满足了；而最小性可以由 [Myhill–Nerode 定理](../misc/fsm.md#myhillnerode-%E5%AE%9A%E7%90%86) 得出。
...
???+ example "对图示的解释"
    ...
    - SAM 上存在一条最长的路径，其标号恰好为字符串 $\texttt{abcbc}$ 本身。该路径从初始状态开始，经过的每个状态都对应着字符串 $\texttt{abcbc}$ 的前缀（$\varnothing,\texttt{a},\texttt{ab},\texttt{abc},\texttt{abcb},\texttt{abcbc}$）。这些状态在后续 [应用](#%E5%90%8E%E7%BC%80%E9%93%BE%E6%8E%A5%E6%A0%91) 中至关重要。
...
例题：[【模板】后缀自动机](https://www.luogu.com.cn/problem/P3804)<sup>[[存档](https://web.archive.org/web/20210817212710/https://www.luogu.com.cn/problem/P3804)]</sup>，[SDOI2016 生成魔咒](https://loj.ac/problem/2033)<sup>[[存档](https://web.archive.org/web/20230605155441/https://loj.ac/problem/2033)]</sup>
...
例题：[SPOJ - SUBLEX](https://www.spoj.com/problems/SUBLEX/)<sup>[[存档](https://web.archive.org/web/20250203003241/https://www.spoj.com/problems/SUBLEX/)]</sup>，[TJOI2015 弦论](https://loj.ac/problem/2102)<sup>[[存档](https://web.archive.org/web/20250911061435/https://loj.ac/problem/2102)]</sup>
...
??? note "解法一"
    ...
    单次查询复杂度为 $O(|P|)+O(\textit{answer}(P))$，其中，$\textit{answer}(P)$ 为本次询问的答案。仿照 [状态数为线性的证明](#%E7%8A%B6%E6%80%81%E6%95%B0) 可以说明，后缀链接树的子树大小不会超过该节点的 $\operatorname{endpos}$ 集合的大小的二倍，因此遍历子树的复杂度是 $O(\textit{answer}(P))$ 的。
...
??? note "解法二"
    ...
    我们只需要考虑两个可能有相同 $\operatorname{firstpos}$ 值的不同状态。这种情形只在一个状态是由另一个状态复制而来时发生。然而，这并不会对复杂度分析造成影响。仿照 [状态数为线性的证明](#%E7%8A%B6%E6%80%81%E6%95%B0)，所有这种后缀为 $P$ 的状态数目不会超过 $2\textit{answer}(P)$。
...
例题：[SPOJ Longest Common Substring](https://www.spoj.com/problems/LCS/en/)<sup>[[存档](https://web.archive.org/web/20250622053752/https://www.spoj.com/problems/LCS/en/)]</sup>
...
例题：[SPOJ Longest Common Substring II](https://www.spoj.com/problems/LCS2/)<sup>[[存档](https://web.archive.org/web/20181113044725/https://www.spoj.com/problems/LCS2/)]</sup>


## 习题


- [HihoCoder #1441 : 后缀自动机一·基本概念](http://hihocoder.com/problemset/problem/1441)<sup>[[存档](https://web.archive.org/web/20181223220139/http://hihocoder.com/problemset/problem/1441)]</sup>
- [【模板】后缀自动机](https://www.luogu.com.cn/problem/P3804)<sup>[[存档](https://web.archive.org/web/20210817212710/https://www.luogu.com.cn/problem/P3804)]</sup>
- [SDOI2016 生成魔咒](https://loj.ac/problem/2033)<sup>[[存档](https://web.archive.org/web/20230605155441/https://loj.ac/problem/2033)]</sup>
- [SPOJ - SUBLEX](https://www.spoj.com/problems/SUBLEX/)<sup>[[存档](https://web.archive.org/web/20250203003241/https://www.spoj.com/problems/SUBLEX/)]</sup>
- [TJOI2015 弦论](https://loj.ac/problem/2102)<sup>[[存档](https://web.archive.org/web/20250911061435/https://loj.ac/problem/2102)]</sup>
- [SPOJ Longest Common Substring](https://www.spoj.com/problems/LCS/en/)<sup>[[存档](https://web.archive.org/web/20250622053752/https://www.spoj.com/problems/LCS/en/)]</sup>
- [SPOJ Longest Common Substring II](https://www.spoj.com/problems/LCS2/)<sup>[[存档](https://web.archive.org/web/20181113044725/https://www.spoj.com/problems/LCS2/)]</sup>
- [Codeforces 1037H Security](https://codeforces.com/problemset/problem/1037/H)<sup>[[存档](https://web.archive.org/web/20230601160403/https://codeforces.com/problemset/problem/1037/H)]</sup>
- [Codeforces 666E Forensic Examination](https://codeforces.com/problemset/problem/666/E)<sup>[[存档](https://web.archive.org/web/20240907162058/https://codeforces.com/problemset/problem/666/E)]</sup>
- [HDU4416 Good Article Good sentence](https://acm.hdu.edu.cn/showproblem.php?pid=4416)<sup>[[存档](https://web.archive.org/web/20250908104220/https://acm.hdu.edu.cn/showproblem.php?pid=4416)]</sup>
- [HDU4436 str2int](https://acm.hdu.edu.cn/showproblem.php?pid=4436)<sup>[[存档](https://web.archive.org/web/20240731134404/https://acm.hdu.edu.cn/showproblem.php?pid=4436)]</sup>
- [HDU6583 Typewriter](https://acm.hdu.edu.cn/showproblem.php?pid=6583)<sup>[[存档](https://web.archive.org/web/20240725172621/https://acm.hdu.edu.cn/showproblem.php?pid=6583)]</sup>
- [Codeforces 235C Cyclical Quest](https://codeforces.com/problemset/problem/235/C)<sup>[[存档](https://web.archive.org/web/20210925053059/https://codeforces.com/problemset/problem/235/C)]</sup>
- [CTSC2012 熟悉的文章](https://www.luogu.com.cn/problem/P4022)<sup>[[存档](https://web.archive.org/web/20210817201055/https://www.luogu.com.cn/problem/P4022)]</sup>
- [NOI2018 你的名字](https://uoj.ac/problem/395)<sup>[[存档](https://web.archive.org/web/20221004122242/https://uoj.ac/problem/395)]</sup>
...
- 《后缀自动机在字典树上的拓展》，刘研绎。
- 《后缀自动机及其应用》，张天扬。
- <https://www.cnblogs.com/zinthos/p/3899679.html><sup>[[存档](https://web.archive.org/web/20240229092405/https://www.cnblogs.com/zinthos/p/3899679.html)]</sup>
- <https://codeforces.com/blog/entry/20861><sup>[[存档](https://web.archive.org/web/20240725122742/https://codeforces.com/blog/entry/20861)]</sup>
- <https://zhuanlan.zhihu.com/p/25948077><sup>[[存档](https://web.archive.org/web/20200928031447/https://zhuanlan.zhihu.com/p/25948077)]</sup>

**本页面主要译自博文 [Суффиксный автомат](http://e-maxx.ru/algo/suffix_automata)<sup>[[存档](https://web.archive.org/web/20210817005605/http://e-maxx.ru/algo/suffix_automata)]</sup> 与其英文翻译版 [Suffix Automaton](https://cp-algorithms.com/string/suffix-automaton.html)<sup>[[存档](https://web.archive.org/web/20230929163926/https://cp-algorithms.com/string/suffix-automaton.html)]</sup>。其中俄文版版权协议为 Public Domain + Leave a Link；英文版版权协议为 CC-BY-SA 4.0。**
