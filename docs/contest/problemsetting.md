...
例子：[「XR-1」柯南家族](https://www.luogu.com.cn/problem/P5346)<sup>[[存档](https://web.archive.org/web/20220724190909/https://www.luogu.com.cn/problem/P5346)]</sup>，做法的前后两部分完全割裂，前半部分为 [「模板」树上后缀排序](https://www.luogu.com.cn/problem/P5353)<sup>[[存档](https://web.archive.org/web/20231013104351/https://www.luogu.com.cn/problem/P5353)]</sup>，后半部分是经典树上问题。就算是随意输入树的点权，依然可以做第二部分，前后部分没有联系。
...
经典例子：[NOIP2017 小凯的疑惑](https://uoj.ac/problem/329)<sup>[[存档](https://web.archive.org/web/20241231193929/https://uoj.ac/problem/329)]</sup>
...
经典例子：[「清华集训 2015」多边形下海](https://uoj.ac/problem/159)<sup>[[存档](https://web.archive.org/web/20200918222003/https://uoj.ac/problem/159)]</sup>
...
经典例子：[「SDOI2010」猪国杀](https://loj.ac/problem/2885)<sup>[[存档](https://web.archive.org/web/20241231193937/https://loj.ac/problem/2885)]</sup>，[「集训队互测 2015」未来程序·改](https://uoj.ac/problem/98)<sup>[[存档](https://web.archive.org/web/20211026093037/https://uoj.ac/problem/98)]</sup>
...
- [LaTeX 入门](../tools/latex.md#%E5%9B%BE%E8%A1%A8)
- [LaTeX 数学公式大全](https://www.luogu.com.cn/blog/IowaBattleship/latex-gong-shi-tai-quan)<sup>[[存档](https://web.archive.org/web/20201129093636/https://www.luogu.com.cn/blog/IowaBattleship/latex-gong-shi-tai-quan)]</sup>
- [LaTeX 各种命令，符号](https://blog.csdn.net/garfielder007/article/details/51646604)<sup>[[存档](https://web.archive.org/web/20180326214129/https://blog.csdn.net/garfielder007/article/details/51646604)]</sup>
...
题面中的每个可能不被理解的定义都应得到解释，不应凭空冒出未加定义的概念。例如：在 [CF1172D Nauuo and Portals](https://codeforces.com/problemset/problem/1172/D)<sup>[[存档](https://web.archive.org/web/20241231193925/https://codeforces.com/problemset/problem/1172/D)]</sup> 中，你必须在题面中解释什么是「传送门」。
...
你需要保证你的题面不会自相矛盾。例如：在 [CF1173A Nauuo and Votes](https://codeforces.com/problemset/problem/1173/A)<sup>[[存档](https://web.archive.org/web/20210926161020/https://codeforces.com/problemset/problem/1173/A)]</sup> 中，没有把 "?" 作为一种 "result"，是因为 "?" 的含义是 "there are more than one possible results"。


你需要保证你的题面不能被错误理解而自圆其说，即使这种理解是反常识、没有人会这么去想的。例如：在 [CF1172D Nauuo and Portals](https://codeforces.com/problemset/problem/1172/D)<sup>[[存档](https://web.archive.org/web/20241231193925/https://codeforces.com/problemset/problem/1172/D)]</sup> 中，之所以要繁琐地定义 "walk into" 并与 "teleport" 区分，是为了防止这种理解：通过传送门可以到另一个传送门，而到了传送门会传送，因此会反复横跳。


顺着读题目描述应当能看懂每一句话，并理解题目的任务与要求。至少在紧接着的下一段话中疑惑能够得到解释，而不是需要在若干段后才能得到解释，或者要看了输入输出格式才能明白题意，甚至需要根据样例来猜题意。例如：在 [「GuOJ Round #1」琪露诺的冰雪宴会](https://github.com/OI-wiki/problemset/blob/master/contest/online/GuOJ/OI%20Archive%20-%20GuOJ1171.pdf)<sup>[[存档](https://web.archive.org/web/20220818005405/https://github.com/OI-wiki/problemset/blob/master/contest/online/GuOJ/OI%20Archive%20-%20GuOJ1171.pdf)]</sup> 中，在输出格式才第一次出现了题目的目标「雾之湖最终能接收到的最大水量」，再加上「灵梦当然能很快算出来清理完全部小溪的总费用是多少」这句带有误解性质的话，更容易使人读错题意，这是不可取的，应当在题目描述中就对题目的目标进行说明。（在这个例子中还存在题目背景严重影响题意理解的问题。）相同的错误还出现在 [CF1423(4)N Bubblesquare Tokens](https://codeforces.com/problemset/problem/1423/N)<sup>[[存档](https://web.archive.org/web/20210804202759/https://codeforces.com/problemset/problem/1423/N)]</sup> 中，在输出格式才第一次出现了题目的目标 "friend pairs and number of tokens each of them gets on behalf of their friendship"。
...
有多种输出的题（如 [CF1173A Nauuo and Votes](https://codeforces.com/problemset/problem/1173/A)<sup>[[存档](https://web.archive.org/web/20210926161020/https://codeforces.com/problemset/problem/1173/A)]</sup>），每种输出都应在样例中出现。例外：实际上不可能无解，但要求判断是否有解的题目。
...
需要注意的是，在数据范围小于 $5\cdot 10^5$ 时，应当考虑是否能使用 [指令集](https://ouuan.github.io/post/n%E6%96%B9%E8%BF%87%E7%99%BE%E4%B8%87-%E6%9A%B4%E5%8A%9B%E7%A2%BE%E6%A0%87%E7%AE%97%E2%80%94%E2%80%94%E6%8C%87%E4%BB%A4%E9%9B%86%E4%BC%98%E5%8C%96%E7%9A%84%E5%9F%BA%E7%A1%80%E4%BD%BF%E7%94%A8)<sup>[[存档](https://web.archive.org/web/20221113132856/https://ouuan.github.io/post/n%E6%96%B9%E8%BF%87%E7%99%BE%E4%B8%87-%E6%9A%B4%E5%8A%9B%E7%A2%BE%E6%A0%87%E7%AE%97%E2%80%94%E2%80%94%E6%8C%87%E4%BB%A4%E9%9B%86%E4%BC%98%E5%8C%96%E7%9A%84%E5%9F%BA%E7%A1%80%E4%BD%BF%E7%94%A8)]</sup> 通过。
...
特殊性质部分分的设置要依具体题目而定。理想的特殊性质部分分应当是能够引导选手思考正解的。与较小数据范围部分分不同，在你不会针对某种特殊性质的做法时，最好不要给这种特殊性质一档分。例如：[「CTS2019」随机立方体](https://loj.ac/problem/3119)<sup>[[存档](https://web.archive.org/web/20210922013045/https://loj.ac/problem/3119)]</sup> 的 $k=1$ 这档部分分在讲题时就被很多人吐槽，称这档部分分妨碍了思考正解。
...
约数尽量多：可以参考 OEIS 上的 [A002182](http://oeis.org/A002182)<sup>[[存档](https://web.archive.org/web/20101229032515/http://oeis.org/A002182)]</sup> 数列。
...
如果不是在考场上，还可以使用 [Tree-Generator](https://github.com/ouuan/Tree-Generator)<sup>[[存档](https://web.archive.org/web/20250826095610/https://github.com/ouuan/Tree-Generator)]</sup> 来生成各种各样的树。
...
1. 直接使用 Linux 环境生成数据。
2. 通过 [`dos2unix`](https://dos2unix.sourceforge.io/)<sup>[[存档](https://web.archive.org/web/20220828234228/https://dos2unix.sourceforge.io/)]</sup> 工具对输入输出文件进行转换，此工具包含于 Cygwin, MinGW 等工具链中。
3. 使用二进制方式打开输出文件，并且使用 `\n` 换行格式。
4. 参考 [此页面](https://help.luogu.com.cn/manual/luogu/problem/testcase-format#%E9%99%84%E5%BD%95windows-%E7%8E%AF%E5%A2%83%E4%B8%8B%E9%80%A0%E6%95%B0%E6%8D%AE%E6%B3%A8%E6%84%8F%E4%BA%8B%E9%A1%B9)<sup>[[存档](https://web.archive.org/web/20241210082504/https://help.luogu.com.cn/manual/luogu/problem/testcase-format#%E9%99%84%E5%BD%95windows-%E7%8E%AF%E5%A2%83%E4%B8%8B%E9%80%A0%E6%95%B0%E6%8D%AE%E6%B3%A8%E6%84%8F%E4%BA%8B%E9%A1%B9)]</sup> 中 `dos2unix.cpp` 代码自行编写工具。
...
在类 CF/ATC 这种线上赛的比赛中，需要尽量保证难度的递增（虽然由于对难度的误估很多时候都并不能真正做到），并且尽量避免出现大的 difficulty gap。可以通过把一题分为难易两题（两个 subtask）来减少 difficulty gap，但是分 subtask 需要谨慎考虑，也有很多人不喜欢 CF 赛制中的 subtask（[Are subtasks evil?](https://codeforces.com/blog/entry/71700)<sup>[[存档](https://web.archive.org/web/20230530090445/https://codeforces.com/blog/entry/71700)]</sup>），原因包括但不限于：
...
有了出题资格后，在侧边栏可以看到 [Propose a contest/problems](http://codeforces.com/proposals/new-contest)<sup>[[存档](https://web.archive.org/web/20220407002856/http://codeforces.com/proposals/new-contest)]</sup> 按钮。
...
实际上，如果 proposal 长时间没有过审，可以考虑私信联系管理（其实 CF 上写了 "Don't send private messages or emails to coordinators"，但 300iq 在 [评论](http://codeforces.com/blog/entry/64077#comment-478933)<sup>[[存档](https://web.archive.org/web/20200124110009/http://codeforces.com/blog/entry/64077#comment-478933)]</sup> 中表示可以私信他）。


### Comet OJ


[Comet OJ 链接](https://www.cometoj.com/)<sup>[[存档](https://web.archive.org/web/20231215072838/https://www.cometoj.com/)]</sup>


已经不再活跃（截至 2021 年 11 月，最后一场比赛是 2020 年 1 月的）。


出题申请：<https://info.cometoj.com/contests/Questionnaire_IssuerInfo/><sup>[[存档](https://web.archive.org/web/20221209011858/https://info.cometoj.com/contests/Questionnaire_IssuerInfo/)]</sup>
...
出题 FAQ：<https://www.codechef.com/wiki/faq-problem-setters><sup>[[存档](https://web.archive.org/web/20200524231732/https://www.codechef.com/wiki/faq-problem-setters)]</sup>


出题指南：<https://www.codechef.com/problemsetting><sup>[[存档](https://web.archive.org/web/20241231193922/https://www.codechef.com/problemsetting)]</sup>
...
1. [vfk《UOJ 精神之源流》](https://vfleaking.blog.uoj.ac/blog/909 "vfk《UOJ 精神之源流》")<sup>[[存档](https://web.archive.org/web/20171227195912/https://vfleaking.blog.uoj.ac/blog/909)]</sup>

2. [王天懿《论偏题的危害》](https://github.com/OI-wiki/libs/blob/master/topic/7-%E7%8E%8B%E5%A4%A9%E6%87%BF-%E8%AE%BA%E5%81%8F%E9%A2%98%E7%9A%84%E5%8D%B1%E5%AE%B3.ppt "王天懿《论偏题的危害》")<sup>[[存档](https://web.archive.org/web/20241231193912/https://github.com/OI-wiki/libs/blob/master/topic/7-%E7%8E%8B%E5%A4%A9%E6%87%BF-%E8%AE%BA%E5%81%8F%E9%A2%98%E7%9A%84%E5%8D%B1%E5%AE%B3.ppt)]</sup>

3. [CF 出题人须知](https://docs.google.com/document/d/e/2PACX-1vRhazTXxSdj7JEIC7dp-nOWcUFiY8bXi9lLju-k6vVMKf4IiBmweJoOAMI-ZEZxatXF08I9wMOQpMqC/pub "CF 出题人须知")<sup>[[存档](https://web.archive.org/web/20241231193926/https://docs.google.com/document/d/e/2PACX-1vRhazTXxSdj7JEIC7dp-nOWcUFiY8bXi9lLju-k6vVMKf4IiBmweJoOAMI-ZEZxatXF08I9wMOQpMqC/pub)]</sup>（[国内可访问的图片版](https://github.com/OI-wiki/libs/blob/master/topic/rules.jpg)<sup>[[存档](https://web.archive.org/web/20241231193913/https://github.com/OI-wiki/libs/blob/master/topic/rules.jpg)]</sup>）

4. [CF 出题人的自我修养](https://github.com/OI-wiki/libs/blob/master/topic/CF%E5%87%BA%E9%A2%98%E4%BA%BA%E7%9A%84%E8%87%AA%E6%88%91%E4%BF%AE%E5%85%BB.md "CF 出题人的自我修养")<sup>[[存档](https://web.archive.org/web/20241231193924/https://github.com/OI-wiki/libs/blob/master/topic/CF%E5%87%BA%E9%A2%98%E4%BA%BA%E7%9A%84%E8%87%AA%E6%88%91%E4%BF%AE%E5%85%BB.md)]</sup>

本文由作者本人自 [ouuan 的出题规范](https://ouuan.github.io/post/ouuan-%E7%9A%84%E5%87%BA%E9%A2%98%E8%A7%84%E8%8C%83/)<sup>[[存档](https://web.archive.org/web/20230609053425/https://ouuan.github.io/post/ouuan-%E7%9A%84%E5%87%BA%E9%A2%98%E8%A7%84%E8%8C%83/)]</sup> 搬运而来并有所修改、补充。
