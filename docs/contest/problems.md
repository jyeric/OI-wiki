...
STDIO 交互（标准 I/O 交互）是 Codeforces、AtCoder 等在线平台的交互手段，也是 ICPC 系列赛事中的标准。Codeforces 提供了一个更加简要的 [说明（英文）](https://codeforces.com/blog/entry/45307)<sup>[[存档](https://web.archive.org/web/20250501025418/https://codeforces.com/blog/entry/45307)]</sup>。
...
通信题的例子有：[UOJ #178. 新年的贺电](https://uoj.ac/problem/178)<sup>[[存档](https://web.archive.org/web/20200109140032/https://uoj.ac/problem/178)]</sup>，[#454.【UER #8】打雪仗](https://uoj.ac/problem/454)<sup>[[存档](https://web.archive.org/web/20250716213157/https://uoj.ac/problem/454)]</sup> 等。
...
这种题在 [LeetCode](https://leetcode.com/)<sup>[[存档](https://web.archive.org/web/20171231111558/https://leetcode.com/)]</sup> 和 [PTA - 拼题 A](https://pintia.cn/problem-sets)<sup>[[存档](https://web.archive.org/web/20230405064823/https://pintia.cn/problem-sets)]</sup> 上比较多见。
