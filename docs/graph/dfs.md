...
DFS 全称是 [Depth First Search](https://en.wikipedia.org/wiki/Depth-first_search)<sup>[[存档](https://web.archive.org/web/20111130090422/https://en.wikipedia.org/wiki/Depth-first_search)]</sup>，中文名是深度优先搜索，是一种用于遍历或搜索树或图的算法。所谓深度优先，就是说每次都尝试向更深的节点走。
...
以 [邻接表（Adjacency List）](./save.md#%E9%82%BB%E6%8E%A5%E8%A1%A8) 作为图的存储方式：
...
以 [链式前向星](./save.md#%E9%93%BE%E5%BC%8F%E5%89%8D%E5%90%91%E6%98%9F) 为例：
...
[DFS 树](./scc.md#dfs-%E7%94%9F%E6%88%90%E6%A0%91) 有很多性质，比如可以用来求 [强连通分量](./scc.md)。
