...
网络流 24 题是中文互联网上广泛流传的一个题单（[LibreOJ](https://loj.ac/problems/tag/30)<sup>[[存档](https://web.archive.org/web/20250212113959/https://loj.ac/problems/tag/30)]</sup>/[洛谷](https://www.luogu.com.cn/problem/list?tag=332)<sup>[[存档](https://web.archive.org/web/20250723071413/https://www.luogu.com.cn/problem/list?tag=332)]</sup>），至少在 2010 年前后就已经存在。该题单引入了一些经典的将其他问题建模为网络流问题的技巧。由于时代的局限性，这些问题未必是最具代表性的网络流问题，但仍值得有志于算法竞赛的读者一阅。
