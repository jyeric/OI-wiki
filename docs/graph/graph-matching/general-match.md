...
- [UOJ #79. 一般图最大匹配](https://uoj.ac/problem/79)<sup>[[存档](https://web.archive.org/web/20250423014729/https://uoj.ac/problem/79)]</sup>
- [UOJ#171.【WC2016】挑战 NPC](https://uoj.ac/problem/171)<sup>[[存档](https://web.archive.org/web/20241205150556/https://uoj.ac/problem/171)]</sup>

## 参考资料


1. Mucha M, Sankowski P.[Maximum matchings via Gaussian elimination](http://web.eecs.umich.edu/~pettie/matching/Mucha-Sankowski-maximum-matching-matrix-multiplication.pdf)<sup>[[存档](https://web.archive.org/web/20170810155416/http://web.eecs.umich.edu/~pettie/matching/Mucha-Sankowski-maximum-matching-matrix-multiplication.pdf)]</sup>
2. 周子鑫，杨家齐《基于线性代数的一般图匹配》
3. ZYQN [《基于线性代数的一般图匹配算法》](https://oi.cyo.ng/wp-content/uploads/2017/02/maximum_matchings_via_gaussian_elimination.pdf)<sup>[[存档](https://web.archive.org/web/20210621104459/https://oi.cyo.ng/wp-content/uploads/2017/02/maximum_matchings_via_gaussian_elimination.pdf)]</sup>
