...
显然，$G$ 是自身的子图，支撑子图，导出子图；[无边图](#%E7%89%B9%E6%AE%8A%E7%9A%84%E5%9B%BE) 是 $G$ 的支撑子图。原图 $G$ 和无边图都是 $G$ 的平凡子图。
...
[OI 中转站 - 图论概念梳理](https://yhx-12243.github.io/OI-transit/memos/14.html)<sup>[[存档](https://web.archive.org/web/20201027202254/https://yhx-12243.github.io/OI-transit/memos/14.html)]</sup>


[Wikipedia](https://en.wikipedia.org/wiki/Glossary_of_graph_theory_terms)<sup>[[存档](https://web.archive.org/web/20181119123938/https://en.wikipedia.org/wiki/Glossary_of_graph_theory_terms)]</sup>（以及相关概念的对应词条）
