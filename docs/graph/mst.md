...
在边具有较多特殊性质的问题中，Boruvka 算法具有优势。例如 [CF888G](https://codeforces.com/problemset/problem/888/G)<sup>[[存档](https://web.archive.org/web/20231207224625/https://codeforces.com/problemset/problem/888/G)]</sup> 的完全图问题。
...
下面通过一张动态图来举一个例子（图源自 [维基百科](https://en.wikipedia.org/wiki/Bor%C5%AFvka%27s_algorithm)<sup>[[存档](https://web.archive.org/web/20181128022433/https://en.wikipedia.org/wiki/Bor%C5%AFvka%27s_algorithm)]</sup>）：


![eg](./images/mst-1.apng)


当原图连通时，每次迭代连通块数量至少减半，算法只会迭代不超过 $O(\log V)$ 次，而原图不连通时相当于多个子问题，因此算法复杂度是 $O(E\log V)$ 的。给出算法的伪代码：（修改自 [维基百科](https://en.wikipedia.org/wiki/Bor%C5%AFvka%27s_algorithm)<sup>[[存档](https://web.archive.org/web/20181128022433/https://en.wikipedia.org/wiki/Bor%C5%AFvka%27s_algorithm)]</sup>）
...
- [「HAOI2006」聪明的猴子](https://www.luogu.com.cn/problem/P2504)<sup>[[存档](https://web.archive.org/web/20231006021609/https://www.luogu.com.cn/problem/P2504)]</sup>
- [「SCOI2005」繁忙的都市](https://loj.ac/problem/2149)<sup>[[存档](https://web.archive.org/web/20250316022109/https://loj.ac/problem/2149)]</sup>
