...
Tarjan 算法基于对图进行 [深度优先搜索](https://oi-wiki.org/graph/dfs/)<sup>[[存档](https://web.archive.org/web/20231128115125/https://oi-wiki.org/graph/dfs/)]</sup>。我们视每个连通分量为搜索树中的一棵子树，在搜索过程中，维护一个栈，每次把搜索树中尚未处理的节点加入栈中。
...
[USACO Fall/HAOI 2006 受欢迎的牛](https://loj.ac/problem/10091)<sup>[[存档](https://web.archive.org/web/20230605143844/https://loj.ac/problem/10091)]</sup>


[POJ1236 Network of Schools](http://poj.org/problem?id=1236)<sup>[[存档](https://web.archive.org/web/20221127093916/http://poj.org/problem?id=1236)]</sup>
