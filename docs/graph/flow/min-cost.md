...
假设存在更小的 $f_{i+1}$，设它为 $f'*{i+1}$。因为 $f*{i+1}-f_i$ 已经是最短增广路了，所以 $f'_{i+1}-f_i$ 一定对应一个经过 **至少一个负圈** 的增广路。
...
如果使用 [Bellman–Ford 算法](../shortest-path.md#bellmanford-%E7%AE%97%E6%B3%95) 求解最短路，每次找增广路的时间复杂度为 $O(nm)$。设该网络的最大流为 $f$，则最坏时间复杂度为 $O(nmf)$。事实上，SSP 算法是 [伪多项式时间](../../misc/cc-basic.md#pseudo-polynomial-time-%E4%BC%AA%E5%A4%9A%E9%A1%B9%E5%BC%8F%E6%97%B6%E9%97%B4) 的。
...
Primal-Dual 原始对偶算法的思路与 [Johnson 全源最短路径算法](../shortest-path.md#johnson-%E5%85%A8%E6%BA%90%E6%9C%80%E7%9F%AD%E8%B7%AF%E5%BE%84%E7%AE%97%E6%B3%95) 类似，通过为每个点设置一个势能，将网络上所有边的费用（下面简称为边权）全部变为非负值，从而可以应用 Dijkstra 算法找出网络上单位费用最小的增广路。
...
- [「Luogu 4452」航班安排](https://www.luogu.com.cn/problem/P4452)<sup>[[存档](https://web.archive.org/web/20250520042752/https://www.luogu.com.cn/problem/P4452)]</sup>
- [「SDOI 2009」晨跑](https://www.luogu.com.cn/problem/P2153)<sup>[[存档](https://web.archive.org/web/20201129101325/https://www.luogu.com.cn/problem/P2153)]</sup>
- [「SCOI 2007」修车](https://www.luogu.com.cn/problem/P2053)<sup>[[存档](https://web.archive.org/web/20200813150112/https://www.luogu.com.cn/problem/P2053)]</sup>
- [「HAOI 2010」订货](https://www.luogu.com.cn/problem/P2517)<sup>[[存档](https://web.archive.org/web/20220616125307/https://www.luogu.com.cn/problem/P2517)]</sup>
- [「NOI 2012」美食节](https://loj.ac/problem/2674)<sup>[[存档](https://web.archive.org/web/20230208141534/https://loj.ac/problem/2674)]</sup>
