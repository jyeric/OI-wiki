...
> 本节 **性质** 部分内容翻译自 [wcipeg](http://wcipeg.com/wiki/Lowest_common_ancestor)<sup>[[存档](https://web.archive.org/web/20230903121744/http://wcipeg.com/wiki/Lowest_common_ancestor)]</sup>，并做过修改。
...
???+ warning "注意"
    ...
    以下的朴素 Tarjan 实现复杂度为 $O(m \alpha(m+n, n) + n)$。如果需要追求严格线性，可以参考 [Gabow 和 Tarjan 于 1983 年的论文](https://dl.acm.org/doi/pdf/10.1145/800061.808753)<sup>[[存档](https://web.archive.org/web/20221219161422/https://dl.acm.org/doi/pdf/10.1145/800061.808753)]</sup>。其中给出了一种复杂度为 $O(m + n)$ 的做法。
...
注意到欧拉序满足相邻两数之差为 1 或者 -1，所以可以使用 $O(n) \sim O(1)$ 的 [加减 1RMQ](../topic/rmq.md#%E5%8A%A0%E5%87%8F-1rmq) 来做。


时间复杂度 $O(n) \sim O(1)$，空间复杂度 $O(n)$，支持在线查询，常数较大。


#### 例题 [Luogu P3379【模板】最近公共祖先（LCA）](https://www.luogu.com.cn/problem/P3379)<sup>[[存档](https://web.archive.org/web/20201025113817/https://www.luogu.com.cn/problem/P3379)]</sup>
...
- [祖孙询问](https://loj.ac/problem/10135)<sup>[[存档](https://web.archive.org/web/20250417181138/https://loj.ac/problem/10135)]</sup>
- [货车运输](https://loj.ac/problem/2610)<sup>[[存档](https://web.archive.org/web/20221110055344/https://loj.ac/problem/2610)]</sup>
- [点的距离](https://loj.ac/problem/10130)<sup>[[存档](https://web.archive.org/web/20200919222902/https://loj.ac/problem/10130)]</sup>
