...
（由 [Graph Editor](https://csacademy.com/app/graph_editor/)<sup>[[存档](https://web.archive.org/web/20171023044826/https://csacademy.com/app/graph_editor/)]</sup> 生成）
...
1. [Graph coloring - Wikipedia](https://en.wikipedia.org/wiki/Graph_coloring)<sup>[[存档](https://web.archive.org/web/20241231213627/https://en.wikipedia.org/wiki/Graph_coloring)]</sup>
2. Welsh, D. J. A.; Powell, M. B. (1967), "[An upper bound for the chromatic number of a graph and its application to timetabling problems](https://doi.org/10.1093%2Fcomjnl%2F10.1.85)<sup>[[存档](https://web.archive.org/web/20191228194922/https://doi.org/10.1093%2Fcomjnl%2F10.1.85)]</sup>", The Computer Journal, 10 (1): 85–86
