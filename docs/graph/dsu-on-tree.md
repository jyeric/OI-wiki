...
考虑下面的问题：[树上数颜色](https://www.luogu.com.cn/problem/U41492)<sup>[[存档](https://web.archive.org/web/20230923002549/https://www.luogu.com.cn/problem/U41492)]</sup>。
...
1. 某些出题人设置的正解是 dsu on tree 的题
   ...
   如 [CF741D](http://codeforces.com/problemset/problem/741/D)<sup>[[存档](https://web.archive.org/web/20201021163001/http://codeforces.com/problemset/problem/741/D)]</sup>。给一棵树，每个节点的权值是'a' 到'v' 的字母，每次询问要求在一个子树找一条路径，使该路径包含的字符排序后成为回文串。
...
[CF600E Lomsat gelral](http://codeforces.com/problemset/problem/600/E)<sup>[[存档](https://web.archive.org/web/20240806142119/http://codeforces.com/problemset/problem/600/E)]</sup>


题意翻译：树的节点有颜色，一种颜色占领了一个子树，当且仅当没有其他颜色在这个子树中出现得比它多。求占领每个子树的所有颜色之和。


[UOJ284 快乐游戏鸡](https://uoj.ac/problem/284)<sup>[[存档](https://web.archive.org/web/20241205162359/https://uoj.ac/problem/284)]</sup>


[CF1709E XOR Tree](https://codeforces.com/contest/1709/problem/E)<sup>[[存档](https://web.archive.org/web/20230519103259/https://codeforces.com/contest/1709/problem/E)]</sup>


## 参考资料/扩展阅读


[CF741D 作者介绍的 dsu on tree](http://codeforces.com/blog/entry/44351)<sup>[[存档](https://web.archive.org/web/20231208224615/http://codeforces.com/blog/entry/44351)]</sup>


[这位作者的题解](http://codeforces.com/blog/entry/48871)<sup>[[存档](https://web.archive.org/web/20211021160249/http://codeforces.com/blog/entry/48871)]</sup>
