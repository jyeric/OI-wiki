...
**本页面译自博文 [Рёберная связность. Свойства и нахождение](http://e-maxx.ru/algo/rib_connectivity)<sup>[[存档](https://web.archive.org/web/20181203110025/http://e-maxx.ru/algo/rib_connectivity)]</sup>、[Вершинная связность. Свойства и нахождение](http://e-maxx.ru/algo/vertex_connectivity)<sup>[[存档](https://web.archive.org/web/20171222175703/http://e-maxx.ru/algo/vertex_connectivity)]</sup> 与其英文翻译版 [Edge connectivity/Vertex connectivity](https://cp-algorithms.com/graph/edge_vertex_connectivity.html)<sup>[[存档](https://web.archive.org/web/20231130110922/https://cp-algorithms.com/graph/edge_vertex_connectivity.html)]</sup>。其中俄文版版权协议为 Public Domain + Leave a Link；英文版版权协议为 CC-BY-SA 4.0。**


## 延伸阅读


- 论文 [*Connectivity Algorithms*](https://www.cse.msu.edu/~cse835/Papers/Graph_connectivity_revised.pdf)<sup>[[存档](https://web.archive.org/web/20160808150155/https://www.cse.msu.edu/~cse835/Papers/Graph_connectivity_revised.pdf)]</sup> 介绍了近年来连通度计算算法的进展。感兴趣的读者可以自行浏览。
