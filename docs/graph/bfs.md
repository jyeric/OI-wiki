...
BFS 全称是 [Breadth First Search](https://en.wikipedia.org/wiki/Breadth-first_search)<sup>[[存档](https://web.archive.org/web/20211226130800/https://en.wikipedia.org/wiki/Breadth-first_search)]</sup>，中文名是宽度优先搜索，也叫广度优先搜索。
...
### [Codeforces 173B](http://codeforces.com/problemset/problem/173/B)<sup>[[存档](https://web.archive.org/web/20250804093329/http://codeforces.com/problemset/problem/173/B)]</sup>
...
诶？这怎么听起来这么像堆优化的 [Dijkstra](./shortest-path.md#dijkstra-%E7%AE%97%E6%B3%95) 算法呢？事实上，堆优化 Dijkstra 就是优先队列 BFS。


## 习题


- [「NOIP2017」奶酪](https://uoj.ac/problem/332)<sup>[[存档](https://web.archive.org/web/20211019222751/https://uoj.ac/problem/332)]</sup>

双端队列 BFS：


- [CF1063B. Labyrinth](https://codeforces.com/problemset/problem/1063/B)<sup>[[存档](https://web.archive.org/web/20230531030116/https://codeforces.com/problemset/problem/1063/B)]</sup>
- [CF173B. Chamber of Secrets](https://codeforces.com/problemset/problem/173/B)<sup>[[存档](https://web.archive.org/web/20250804093329/https://codeforces.com/problemset/problem/173/B)]</sup>
- [「BalticOI 2011 Day1」打开灯泡 Switch the Lamp On](https://loj.ac/p/2632)<sup>[[存档](https://web.archive.org/web/20230402123345/https://loj.ac/p/2632)]</sup>

## 参考


<https://cp-algorithms.com/graph/breadth-first-search.html><sup>[[存档](https://web.archive.org/web/20221219144110/https://cp-algorithms.com/graph/breadth-first-search.html)]</sup>
