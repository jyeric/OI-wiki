...
作为一个 Wiki，**OI Wiki** 不是发表 [原创研究](https://en.wikipedia.org/wiki/Wikipedia:No_original_research)<sup>[[存档](https://web.archive.org/web/20250912015545/https://en.wikipedia.org/wiki/Wikipedia:No_original_research)]</sup>（如 **新理论及解法**、**原创观点**、**自创定义或词语** 等）的场所。例如：
...
**OI Wiki** 主站不会收录各类 **文献**、**课件**、**讲义**、**说明书** 等资料，若您想提交有关编程竞赛的资料，请移步至 [OI-wiki/libs](https://github.com/OI-wiki/libs)<sup>[[存档](https://web.archive.org/web/20220616125304/https://github.com/OI-wiki/libs)]</sup>。
...
- 历史，艺术等无关领域；
- [TBN 矩阵](https://learnopengl.com/Advanced-Lighting/Normal-Mapping)<sup>[[存档](https://web.archive.org/web/20250901193242/https://learnopengl.com/Advanced-Lighting/Normal-Mapping)]</sup> 等虽然从属于有关领域但目前不能应用于编程竞赛的知识；
- [PID 控制](https://en.wikipedia.org/wiki/PID_controller)<sup>[[存档](https://web.archive.org/web/20211231170256/https://en.wikipedia.org/wiki/PID_controller)]</sup>、[有限元法](https://en.wikipedia.org/wiki/Finite_element_method)<sup>[[存档](https://web.archive.org/web/20241226045847/https://en.wikipedia.org/wiki/Finite_element_method)]</sup> 等目前不能应用于编程竞赛的领域算法；
- [深度学习](https://en.wikipedia.org/wiki/Deep_learning)<sup>[[存档](https://web.archive.org/web/20250909011907/https://en.wikipedia.org/wiki/Deep_learning)]</sup>、[强化学习](https://en.wikipedia.org/wiki/Reinforcement_learning)<sup>[[存档](https://web.archive.org/web/20191228193728/https://en.wikipedia.org/wiki/Reinforcement_learning)]</sup> 等目前不能应用于编程竞赛的通用算法。
