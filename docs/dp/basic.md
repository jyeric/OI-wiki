...
可参考 [SourceForge 的 LCS 交互网页](http://lcs-demo.sourceforge.net/)<sup>[[存档](https://web.archive.org/web/20171209081957/http://lcs-demo.sourceforge.net/)]</sup> 来更好地理解 LCS 的实现过程。
...
[^ref1]: [位运算求最长公共子序列 - -Wallace- - 博客园](https://www.cnblogs.com/-Wallace-/p/bit-lcs.html)<sup>[[存档](https://web.archive.org/web/20250519081504/https://www.cnblogs.com/-Wallace-/p/bit-lcs.html)]</sup>
[^ref2]: [最长不下降子序列 nlogn 算法详解 - lvmememe - 博客园](https://www.cnblogs.com/itlqs/p/5743114.html)<sup>[[存档](https://web.archive.org/web/20250206191031/https://www.cnblogs.com/itlqs/p/5743114.html)]</sup>
