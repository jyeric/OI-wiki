...
由于历史原因，整数类型的位宽有多种流行模型，为解决这一问题，C99/C++11 引入了 [定宽整数类型](#%E5%AE%9A%E5%AE%BD%E6%95%B4%E6%95%B0%E7%B1%BB%E5%9E%8B)。
...
窄字符型位数一般为 $8$ 位，实际上底层存储方式仍然是整数，一般通过 [ASCII 编码](http://www.asciitable.com/)<sup>[[存档](https://web.archive.org/web/20250906152603/http://www.asciitable.com/)]</sup> 实现字符与整数的一一对应，有如下三种：
...
请参阅指针的 [对应章节](./pointer.md#%E7%A9%BA%E6%8C%87%E9%92%88)
...
- 如果目标类型是 `bool`，则是 [布尔转换](#%E5%B8%83%E5%B0%94%E8%BD%AC%E6%8D%A2)。
...
1. [Working Draft, Standard for Programming Language C++](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2022/n4917.pdf)<sup>[[存档](https://web.archive.org/web/20250911030212/https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2022/n4917.pdf)]</sup>
2. [类型 - cppreference.com](https://zh.cppreference.com/w/cpp/language/type)<sup>[[存档](https://web.archive.org/web/20241113142846/https://zh.cppreference.com/w/cpp/language/type)]</sup>
3. C 语言的 [算术类型 - cppreference.com](https://zh.cppreference.com/w/c/language/arithmetic_types)<sup>[[存档](https://web.archive.org/web/20230921092231/https://zh.cppreference.com/w/c/language/arithmetic_types)]</sup>
4. [基础类型 - cppreference.com](https://zh.cppreference.com/w/cpp/language/types)<sup>[[存档](https://web.archive.org/web/20250414032504/https://zh.cppreference.com/w/cpp/language/types)]</sup>
5. [定宽整数类型（C++11 起）- cppreference.com](https://zh.cppreference.com/w/cpp/types/integer)<sup>[[存档](https://web.archive.org/web/20250414054905/https://zh.cppreference.com/w/cpp/types/integer)]</sup>
6. William Kahan (1 October 1997).["Lecture Notes on the Status of IEEE Standard 754 for Binary Floating-Point Arithmetic"](https://people.eecs.berkeley.edu/~wkahan/ieee754status/IEEE754.PDF)<sup>[[存档](https://web.archive.org/web/20201207082430/https://people.eecs.berkeley.edu/~wkahan/ieee754status/IEEE754.PDF)]</sup>.
7. [隐式转换 - cppreference.com](https://zh.cppreference.com/w/cpp/language/implicit_conversion)<sup>[[存档](https://web.archive.org/web/20180718030127/https://zh.cppreference.com/w/cpp/language/implicit_conversion)]</sup>
8. [声明 - cppreference](https://zh.cppreference.com/w/cpp/language/declarations)<sup>[[存档](https://web.archive.org/web/20171223002500/https://zh.cppreference.com/w/cpp/language/declarations)]</sup>
9. [作用域 - cppreference.com](https://zh.cppreference.com/w/cpp/language/scope)<sup>[[存档](https://web.archive.org/web/20180424061030/https://zh.cppreference.com/w/cpp/language/scope)]</sup>

[^note11]: 包括数组类型、引用类型、指针类型、类类型、函数类型等。由于本篇文章是面向初学者的，故不在本文做具体介绍。具体请参阅 [类型 - cppreference.com](https://zh.cppreference.com/w/cpp/language/type)<sup>[[存档](https://web.archive.org/web/20241113142846/https://zh.cppreference.com/w/cpp/language/type)]</sup>
[^note12]: 不包含宽字符类型、位域和枚举类型，详见 [整型转换 - cppreference](https://zh.cppreference.com/w/cpp/language/implicit_conversion#.E6.95.B4.E5.9E.8B.E8.BD.AC.E6.8D.A2)<sup>[[存档](https://web.archive.org/web/20231012064552/https://zh.cppreference.com/w/cpp/language/implicit_conversion#.E6.95.B4.E5.9E.8B.E8.BD.AC.E6.8D.A2)]</sup>。
[^note13]: 自 C++20 起生效。C++20 前结果是实现定义的。详见 [整型转换 - cppreference](https://zh.cppreference.com/w/cpp/language/implicit_conversion#.E6.95.B4.E5.9E.8B.E8.BD.AC.E6.8D.A2)<sup>[[存档](https://web.archive.org/web/20231012064552/https://zh.cppreference.com/w/cpp/language/implicit_conversion#.E6.95.B4.E5.9E.8B.E8.BD.AC.E6.8D.A2)]</sup>。
[^note14]: 定义一个变量时，除了类型说明符之外，还可以包含其他说明符。详见 [声明 - cppreference](https://zh.cppreference.com/w/cpp/language/declarations)<sup>[[存档](https://web.archive.org/web/20171223002500/https://zh.cppreference.com/w/cpp/language/declarations)]</sup>。
[^note15]: 更准确的说法是 [声明点](https://zh.cppreference.com/w/cpp/language/scope#.E5.A3.B0.E6.98.8E.E7.82.B9)<sup>[[存档](https://web.archive.org/web/20210824121855/https://zh.cppreference.com/w/cpp/language/scope#.E5.A3.B0.E6.98.8E.E7.82.B9)]</sup>。
