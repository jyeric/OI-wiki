...
在标准库实现里，每个元素的散列值是将值对一个质数取模得到的，更具体地说，是 [这个列表](https://github.com/gcc-mirror/gcc/blob/releases/gcc-8.1.0/libstdc%2B%2B-v3/src/shared/hashtable-aux.cc)<sup>[[存档](https://web.archive.org/web/20220818005405/https://github.com/gcc-mirror/gcc/blob/releases/gcc-8.1.0/libstdc%2B%2B-v3/src/shared/hashtable-aux.cc)]</sup> 中的质数（g++ 6 及以前版本的编译器，这个质数一般是 $126271$，g++ 7 及之后版本的编译器，这个质数一般是 $107897$）。
...
例如，在 [这篇博客](https://codeforces.com/blog/entry/62393)<sup>[[存档](https://web.archive.org/web/20191225145057/https://codeforces.com/blog/entry/62393)]</sup> 中给出了如下哈希函数：
