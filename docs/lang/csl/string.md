...
下面介绍 `string` 的基本操作，具体可看 [C++ 文档](https://zh.cppreference.com/w/cpp/string/basic_string)<sup>[[存档](https://web.archive.org/web/20241126182945/https://zh.cppreference.com/w/cpp/string/basic_string)]</sup>。
