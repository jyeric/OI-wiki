STL 提供了大约 100 个实现算法的模版函数，基本都包含在 `<algorithm>` 之中，还有一部分包含在 `<numeric>` 和 `<functional>`。完备的函数列表请 [参见参考手册](https://zh.cppreference.com/w/cpp/algorithm)<sup>[[存档](https://web.archive.org/web/20250909001151/https://zh.cppreference.com/w/cpp/algorithm)]</sup>，排序相关的可以参考 [排序内容的对应页面](../../basic/stl-sort.md)。
...
- 使用 `next_permutation` 生成 $1$ 到 $9$ 的全排列。例题：[Luogu P1706 全排列问题](https://www.luogu.com.cn/problem/P1706)<sup>[[存档](https://web.archive.org/web/20231005063707/https://www.luogu.com.cn/problem/P1706)]</sup>
...
- 使用 `lower_bound` 查找有序数组 $a$ 中最接近 $x$ 的元素。例题：[UVa10487 Closest Sums](https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&category=16&page=show_problem&problem=1428)<sup>[[存档](https://web.archive.org/web/20250903030700/https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&category=16&page=show_problem&problem=1428)]</sup>
...
- 使用 `sort` 与 `unique` 查找数组 $a$ 中 **第 $k$ 小的值**（注意：重复出现的值仅算一次，因此本题不是求解第 $k$ 小的元素）。例题：[Luogu P1138 第 k 小整数](https://www.luogu.com.cn/problem/P1138)<sup>[[存档](https://web.archive.org/web/20241212105235/https://www.luogu.com.cn/problem/P1138)]</sup>
