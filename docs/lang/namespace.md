...
有了 `using` 指令，[C++ 语法基础](./basic.md#cin-%E4%B8%8E-cout) 中的代码可以有这两种等价写法：
...
- [Namespaces - cppreference.com](https://en.cppreference.com/w/cpp/language/namespace)<sup>[[存档](https://web.archive.org/web/20241228214959/https://en.cppreference.com/w/cpp/language/namespace)]</sup>
