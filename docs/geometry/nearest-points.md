...
下面我们介绍一种时间复杂度为 $O(n\log n)$ 的分治算法来解决这个问题。该算法在 1975 年由 [Franco P. Preparata](https://en.wikipedia.org/wiki/Franco_P._Preparata)<sup>[[存档](https://web.archive.org/web/20241202075543/https://en.wikipedia.org/wiki/Franco_P._Preparata)]</sup> 提出，Preparata 和 [Michael Ian Shamos](https://en.wikipedia.org/wiki/Michael_Ian_Shamos)<sup>[[存档](https://web.archive.org/web/20241213132922/https://en.wikipedia.org/wiki/Michael_Ian_Shamos)]</sup> 证明了该算法在决策树模型下是最优的。
...
- [SPOJ #8725 CLOPPAIR "Closest Point Pair"[难度：低]](https://www.spoj.com/problems/CLOPPAIR/)<sup>[[存档](https://web.archive.org/web/20250813004903/https://www.spoj.com/problems/CLOPPAIR/)]</sup>
- [CODEFORCES Team Olympiad Saratov - 2011 "Minimum amount"[难度：中]](http://codeforces.com/contest/120/problem/J)<sup>[[存档](https://web.archive.org/web/20111221003414/http://codeforces.com/contest/120/problem/J)]</sup>
- [SPOJ #7029 CLOSEST "Closest Triple"[难度：中]](https://www.spoj.com/problems/CLOSEST/)<sup>[[存档](https://web.archive.org/web/20241118082037/https://www.spoj.com/problems/CLOSEST/)]</sup>
...
**本页面中的分治算法部分主要译自博文 [Нахождение пары ближайших точек](http://e-maxx.ru/algo/nearest_points)<sup>[[存档](https://web.archive.org/web/20151107095604/http://e-maxx.ru/algo/nearest_points)]</sup> 与其英文翻译版 [Finding the nearest pair of points](https://github.com/e-maxx-eng/e-maxx-eng/blob/master/src/geometry/nearest_points.md)<sup>[[存档](https://web.archive.org/web/20221129112459/https://github.com/e-maxx-eng/e-maxx-eng/blob/master/src/geometry/nearest_points.md)]</sup>。其中俄文版版权协议为 Public Domain + Leave a Link；英文版版权协议为 CC-BY-SA 4.0。**


[知乎专栏：计算几何 - 最近点对问题](https://zhuanlan.zhihu.com/p/74905629)<sup>[[存档](https://web.archive.org/web/20220804144314/https://zhuanlan.zhihu.com/p/74905629)]</sup>
