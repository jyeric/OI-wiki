...
具体证明：[Pick's theorem](https://en.wikipedia.org/wiki/Pick%27s_theorem)<sup>[[存档](https://web.archive.org/web/20241216215306/https://en.wikipedia.org/wiki/Pick%27s_theorem)]</sup>
...
## 一道例题 ([POJ 1265](http://poj.org/problem?id=1265)<sup>[[存档](https://web.archive.org/web/20250325015159/http://poj.org/problem?id=1265)]</sup>)
