...
[CP Editor](https://github.com/cpeditor/cpeditor)<sup>[[存档](https://web.archive.org/web/20221227180918/https://github.com/cpeditor/cpeditor)]</sup> 专为算法竞赛设计，不像其它 IDE 主要是为了开发设计的。它可以帮助你自动化编译、运行、测试，从而让你专注于算法设计。它甚至可以从各种算法竞赛网站上获取样例，将代码提交到 [Codeforces](https://codeforces.com/)<sup>[[存档](https://web.archive.org/web/20221231215330/https://codeforces.com/)]</sup> 上！


## 下载与安装


参见 [安装 | CP Editor](https://cpeditor.org/zh/docs/installation/)<sup>[[存档](https://web.archive.org/web/20211021171152/https://cpeditor.org/zh/docs/installation/)]</sup>。
...
- 快捷键
  ...
  具体可以查阅 [官方文档](https://cpeditor.org/zh/docs/preferences/key-bindings/)<sup>[[存档](https://web.archive.org/web/20221202022346/https://cpeditor.org/zh/docs/preferences/key-bindings/)]</sup>。
