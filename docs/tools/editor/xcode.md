...
打开苹果电脑自带的 App Store（或者尝试 [快捷链接](https://apps.apple.com/cn/app/xcode/id497799835?mt=12)<sup>[[存档](https://web.archive.org/web/20211026122621/https://apps.apple.com/cn/app/xcode/id497799835?mt=12)]</sup>）下载 Xcode。点击获取，然后输入苹果账号密码开始下载安装。
...
访问 [苹果开发者下载页面](https://developer.apple.com/download/more/)<sup>[[存档](https://web.archive.org/web/20171224213424/https://developer.apple.com/download/more/)]</sup>，用苹果账号登录，然后找到 Xcode 最新的稳定版本安装包（即不含 Beta 的最新版本，此处为 11.6）：
...
这是因为在 macOS 上默认使用 [libc++](https://libcxx.llvm.org/)<sup>[[存档](https://web.archive.org/web/20201206150348/https://libcxx.llvm.org/)]</sup> 作为 C++ 标准库实现，而万能头 `bits/stdc++.h` 是 [GNU libstdc++](https://gcc.gnu.org/onlinedocs/libstdc++/)<sup>[[存档](https://web.archive.org/web/20230318233800/https://gcc.gnu.org/onlinedocs/libstdc++/)]</sup> 所独有的。
