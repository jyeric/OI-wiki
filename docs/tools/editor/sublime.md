...
ST4 的安装方法参见 [Sublime Text 4 的下载页面](https://www.sublimetext.com/download)<sup>[[存档](https://web.archive.org/web/20241228184907/https://www.sublimetext.com/download)]</sup>。


ST3 的安装方法参见 [Sublime Text 3 的下载页面](https://www.sublimetext.com/3)<sup>[[存档](https://web.archive.org/web/20181230091551/https://www.sublimetext.com/3)]</sup>。
...
如果完成的弹窗显示安装失败（与网络有关），则需要手动下载 [Package Control](https://packagecontrol.io/Package%20Control.sublime-package)<sup>[[存档](https://web.archive.org/web/20240929150448/https://packagecontrol.io/Package%20Control.sublime-package)]</sup> 并将下载好的文件放到 ST 的数据目录下的 `\Installed Packages` 文件夹中。稍作等待，ST 会自动识别该插件（有时需要重启 ST）。
...
如果要编辑自己的配色方案，可以访问 [tmTheme Editor](http://tmtheme-editor.herokuapp.com/)<sup>[[存档](https://web.archive.org/web/20250911142746/http://tmtheme-editor.herokuapp.com/)]</sup>。
...
也可以通过快捷键设置将进入命令模式设置成任意键（具体详见 [设置快捷键](#%E8%AE%BE%E7%BD%AE%E5%BF%AB%E6%8D%B7%E9%94%AE)）。
...
以下列出部分文件后缀以及其用途，具体的插件开发教程详见 [社区文档](https://docs.sublimetext.io/guide/extensibility/plugins/)<sup>[[存档](https://web.archive.org/web/20201125043847/https://docs.sublimetext.io/guide/extensibility/plugins/)]</sup> 和 [官方文档](https://www.sublimetext.com/docs/3/)<sup>[[存档](https://web.archive.org/web/20221006040057/https://www.sublimetext.com/docs/3/)]</sup>：
...
关于宏的保存与绑定按键详见 [社区文档](https://docs.sublimetext.io/guide/extensibility/macros.html)<sup>[[存档](https://web.archive.org/web/20250328132951/https://docs.sublimetext.io/guide/extensibility/macros.html)]</sup>。
...
- [使用命令行调试](../cmd.md)
- [Sublime Text 3 官方文档](https://www.sublimetext.com/docs/3/)<sup>[[存档](https://web.archive.org/web/20221006040057/https://www.sublimetext.com/docs/3/)]</sup>
- [Sublime Text 社区文档](https://docs.sublimetext.io/)<sup>[[存档](https://web.archive.org/web/20211121230300/https://docs.sublimetext.io/)]</sup>

## 参考资料与注释

[^ref1]: [NOI Linux 2.0 发布](https://www.noi.cn/gynoi/jsgz/2021-07-16/732450.shtml)<sup>[[存档](https://web.archive.org/web/20241229074349/https://www.noi.cn/gynoi/jsgz/2021-07-16/732450.shtml)]</sup>
[^ref2]: [Sublime Text 4 发布](https://www.sublimetext.com/blog/articles/sublime-text-4)<sup>[[存档](https://web.archive.org/web/20231230235751/https://www.sublimetext.com/blog/articles/sublime-text-4)]</sup>
[^ref3]: [便捷清新的文本编辑器 sublime](https://www.luogu.com.cn/blog/acking/sublime)<sup>[[存档](https://web.archive.org/web/20210512105901/https://www.luogu.com.cn/blog/acking/sublime)]</sup>
[^ref4]: [Sublime Text Git 集成](https://www.sublimetext.com/docs/git_integration.html)<sup>[[存档](https://web.archive.org/web/20250725091217/https://www.sublimetext.com/docs/git_integration.html)]</sup>
