...
以上的 Dev-C++ 分发都被认为是「官方的」。此外，在 2015 年 Orwell Dev-C++ 停止更新后，因为教学需要，一位来自中国的个人开发者 [royqh1979](https://github.com/royqh1979)<sup>[[存档](https://web.archive.org/web/20241201202723/https://github.com/royqh1979)]</sup> 决定继续开发他的 Dev-C++ 个人分支，命名为小熊猫 Dev-C++[^ref2]，集成了智能提示和高版本的 MinGW64，非常便于国内的个人使用和学习。
...
[^ref1]: 项目源代码托管于 [GitHub](https://github.com/Embarcadero/Dev-Cpp)<sup>[[存档](https://web.archive.org/web/20250826191744/https://github.com/Embarcadero/Dev-Cpp)]</sup> 和 [SourceForge](https://sourceforge.net/projects/embarcadero-devcpp/)<sup>[[存档](https://web.archive.org/web/20231231133018/https://sourceforge.net/projects/embarcadero-devcpp/)]</sup>.
[^ref2]: 源代码托管于 [Github](https://github.com/royqh1979/Dev-Cpp)<sup>[[存档](https://web.archive.org/web/20211226220139/https://github.com/royqh1979/Dev-Cpp)]</sup>
[^ref3]: 项目官网位于 [小熊猫 C++](https://royqh1979.gitee.io/redpandacpp)<sup>[[存档](https://web.archive.org/web/20230529093458/https://royqh1979.gitee.io/redpandacpp)]</sup>，源代码托管于 [Github](https://github.com/royqh1979/RedPanda-CPP/)<sup>[[存档](https://web.archive.org/web/20221001140347/https://github.com/royqh1979/RedPanda-CPP/)]</sup>
