...
参见 [Code::Blocks 官方网站](https://www.codeblocks.org/downloads/)<sup>[[存档](https://web.archive.org/web/20211225203932/https://www.codeblocks.org/downloads/)]</sup>，选择下载二进制安装程序（Binary Release），或者下载源代码编译安装（Source Code），然后根据需求和操作系统选择合适的安装程序，按照安装向导完成安装即可。
...
插件的安装和使用方法请参考 [Code::Blocks 的插件文档](https://wiki.codeblocks.org/index.php/Code::Blocks_Plugins)<sup>[[存档](https://web.archive.org/web/20250306131737/https://wiki.codeblocks.org/index.php/Code::Blocks_Plugins)]</sup>，根据插件的需求和功能，选择合适的插件安装和使用。
...
[^ref1]: [Code::Blocks - 维基百科](https://zh.wikipedia.org/wiki/Code::Blocks)<sup>[[存档](https://web.archive.org/web/20210624151618/https://zh.wikipedia.org/wiki/Code::Blocks)]</sup>
