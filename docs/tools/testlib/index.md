...
Testlib 与 Codeforces 开发的 [Polygon](https://polygon.codeforces.com/)<sup>[[存档](https://web.archive.org/web/20221226071147/https://polygon.codeforces.com/)]</sup> 出题平台完全兼容。


`testlib.h` 在 2005 年移植自 `testlib.pas`，并一直在更新。Testlib 与绝大多数编译器兼容，如 VC++ 和 GCC g++，并兼容 C++11。


**本文主要翻译自 [Testlib - Codeforces](https://codeforces.com/testlib)<sup>[[存档](https://web.archive.org/web/20231207195714/https://codeforces.com/testlib)]</sup>。`testlib.h` 的 GitHub 存储库为 [MikeMirzayanov/testlib](https://github.com/MikeMirzayanov/testlib)<sup>[[存档](https://web.archive.org/web/20250825021029/https://github.com/MikeMirzayanov/testlib)]</sup>。**
