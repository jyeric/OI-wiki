...
**本文主要翻译自 [Interactors with testlib.h - Codeforces](https://codeforces.com/blog/entry/18455)<sup>[[存档](https://web.archive.org/web/20240507053305/https://codeforces.com/blog/entry/18455)]</sup>。`testlib.h` 的 GitHub 存储库为 [MikeMirzayanov/testlib](https://github.com/MikeMirzayanov/testlib)<sup>[[存档](https://web.archive.org/web/20250825021029/https://github.com/MikeMirzayanov/testlib)]</sup>。**
