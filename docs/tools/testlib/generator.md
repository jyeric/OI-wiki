...
可以在 [GitHub](https://github.com/MikeMirzayanov/testlib/tree/master/generators)<sup>[[存档](https://web.archive.org/web/20230921084559/https://github.com/MikeMirzayanov/testlib/tree/master/generators)]</sup> 中找到。


**本文主要翻译自 [Генераторы на testlib.h - Codeforces](https://codeforces.com/blog/entry/18291)<sup>[[存档](https://web.archive.org/web/20250819172111/https://codeforces.com/blog/entry/18291)]</sup> 。新特性翻译自 [Testlib: Opts—parsing command line options](https://codeforces.com/blog/entry/72702)<sup>[[存档](https://web.archive.org/web/20231211133856/https://codeforces.com/blog/entry/72702)]</sup> 。 `testlib.h` 的 GitHub 存储库为 [MikeMirzayanov/testlib](https://github.com/MikeMirzayanov/testlib)<sup>[[存档](https://web.archive.org/web/20250825021029/https://github.com/MikeMirzayanov/testlib)]</sup> 。**
