...
网址：[Index Page - Polygon](https://polygon.codeforces.com)<sup>[[存档](https://web.archive.org/web/20201212220959/https://polygon.codeforces.com)]</sup>
...
如果这些代码需要 include 其它文件，例如 [Tree-Generator](https://github.com/ouuan/Tree-Generator)<sup>[[存档](https://web.archive.org/web/20250826095610/https://github.com/ouuan/Tree-Generator)]</sup>，需要放在 "Resource Files" 中。


grader 式交互参见 [官方教程](https://codeforces.com/blog/entry/66916)<sup>[[存档](https://web.archive.org/web/20240713120827/https://codeforces.com/blog/entry/66916)]</sup>。
...
可以参考 [Polygon 提供的教程](https://polygon.codeforces.com/docs/freemarker-manual)<sup>[[存档](https://web.archive.org/web/20221201175002/https://polygon.codeforces.com/docs/freemarker-manual)]</sup> 使用 Freemarker 来批量生成脚本。
