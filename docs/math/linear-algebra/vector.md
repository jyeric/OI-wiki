...
对于三维空间，向量旋转需要使用两个角度参量，即天顶角旋转角度与方向角旋转角度，可以利用 [空间球坐标系](../coordinate.md#%E7%A9%BA%E9%97%B4%E7%90%83%E5%9D%90%E6%A0%87%E7%B3%BB) 进行旋转操作。
...
[^note1]: 参见 [Rotation matrix from axis and angle - Wikipedia](https://en.wikipedia.org/wiki/Rotation_matrix#Rotation_matrix_from_axis_and_angle)<sup>[[存档](https://web.archive.org/web/20250907065535/https://en.wikipedia.org/wiki/Rotation_matrix#Rotation_matrix_from_axis_and_angle)]</sup>
