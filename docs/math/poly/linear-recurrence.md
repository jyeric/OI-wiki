...
\begin{cases}
p_0q_0^{-1},&\text{ if }N=0, \
\left(p_N-\sum*{j=1}^{N}q_j\tilde{q}*{N-j}\right)\cdot q_0^{-1},&\text{ else if }N<d, \
-q_0^{-1}\sum*{j=1}^{d}q_j\tilde{q}_{N-j},&\text{ otherwise}.
\end{cases}
$$
...
1. Alin Bostan, Ryuhei Mori.[A Simple and Fast Algorithm for Computing the $N$-th Term of a Linearly Recurrent Sequence](https://arxiv.org/abs/2008.08822)<sup>[[存档](https://web.archive.org/web/20240829093607/https://arxiv.org/abs/2008.08822)]</sup>.
