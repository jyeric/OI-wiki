...
在数学中，NTT 是关于任意 [环](../algebra/basic.md#%E7%8E%AF) 上的离散傅立叶变换（DFT）。在有限域的情况下，通常称为数论变换（NTT）。
...
下面是一个大数相乘的模板，[参考来源](https://blog.csdn.net/blackjack_/article/details/79346433)<sup>[[存档](https://web.archive.org/web/20230419032803/https://blog.csdn.net/blackjack_/article/details/79346433)]</sup>。
...
1. [FWT（快速沃尔什变换）零基础详解 qaq（ACM/OI）](https://zhuanlan.zhihu.com/p/41867199)<sup>[[存档](https://web.archive.org/web/20220722090657/https://zhuanlan.zhihu.com/p/41867199)]</sup>
2. [FFT（快速傅里叶变换）0 基础详解！附 NTT（ACM/OI）](https://zhuanlan.zhihu.com/p/40505277)<sup>[[存档](https://web.archive.org/web/20220722090657/https://zhuanlan.zhihu.com/p/40505277)]</sup>
3. [Number-theoretic transform(NTT) - Wikipedia](https://en.wikipedia.org/wiki/Discrete_Fourier_transform_%28general%29#Number-theoretic_transform)<sup>[[存档](https://web.archive.org/web/20241224184654/https://en.wikipedia.org/wiki/Discrete_Fourier_transform_%28general%29#Number-theoretic_transform)]</sup>
4. [Tutorial on FFT/NTT—The tough made simple. (Part 1)](https://codeforces.com/blog/entry/43499)<sup>[[存档](https://web.archive.org/web/20250814043921/https://codeforces.com/blog/entry/43499)]</sup>
