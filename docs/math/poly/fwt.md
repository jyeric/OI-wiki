...
> 沃尔什转换（Walsh Transform）是在频谱分析上作为离散傅立叶变换的替代方案的一种方法。——[维基百科](https://zh.wikipedia.org/zh-cn/%E6%B2%83%E7%88%BE%E4%BB%80%E8%BD%89%E6%8F%9B)<sup>[[存档](https://web.archive.org/web/20250405051925/https://zh.wikipedia.org/zh-cn/%E6%B2%83%E7%88%BE%E4%BB%80%E8%BD%89%E6%8F%9B)]</sup
...
我们按照定义，显然可以构造 $FWT[A]*i = A'_i = \sum*{i=i\cup j}A_{j}$，来表示 $j$ 满足二进制中 $1$ 为 $i$ 的子集。
...
$$
\begin{aligned}
FWT[A]*i\cdot FWT[B]_i&=\left(\sum*{i\cup j=i} A_j\right)\left(\sum_{i\cup k=i} B_k\right) \
...
$$
\begin{aligned}
FWT[A]*iFWT[B]_i&=\left(\sum*{i\circ j=0}A_j-\sum_{i\circ j=1}A_j\right)\left(\sum_{i\circ k=0}B_k-\sum_{i\circ k=1}B_k\right) \
...
此即为 [范德蒙德矩阵](https://en.wikipedia.org/wiki/Vandermonde_matrix)<sup>[[存档](https://web.archive.org/web/20221101150450/https://en.wikipedia.org/wiki/Vandermonde_matrix)]</sup>，求逆可得：
...
- [桃酱的算法笔记](https://zhuanlan.zhihu.com/p/41867199)<sup>[[存档](https://web.archive.org/web/20220722090657/https://zhuanlan.zhihu.com/p/41867199)]</sup>
- [ZnPdCo 的博客](https://znpdco.github.io/%E7%AE%97%E6%B3%95/2024/05/07/FWT.html)<sup>[[存档](https://web.archive.org/web/20240717092425/https://znpdco.github.io/%E7%AE%97%E6%B3%95/2024/05/07/FWT.html)]</sup>
