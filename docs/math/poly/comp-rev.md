...
&\textbf{Input}\text{: }P=\sum_{0\leq j< n}p_jy^{-j}\in\mathbb{C}((y)),Q\in\mathbb{C}\left\lbrack x,y\right\rbrack ,n,m\in\mathbb{N}*{>0}\text{.} \
...
4&\left(t*{-(m+d)+1},\dots ,t_0\right)\gets \operatorname{\mathsf{Comp}}\left(P(y),V(x,y),\left\lceil n/2\right\rceil,m+d\right) \
...
&\textbf{Input}\text{: }P,Q\in\mathbb{C}\left\lbrack x,y\right\rbrack ,n,m\in\mathbb{N}*{>0}\text{.} \
...
4&\qquad\qquad P(x,y)\gets \sum*{j=0}^{\left\lceil n/2\right\rceil +1}\left(\left\lbrack x^{2j}\right\rbrack U(x,y)\right)x^j \
5&\qquad \textbf{else} \
...
1. Yasunori Kinoshita, Baitian Li.[Power Series Composition in Near-Linear Time](https://arxiv.org/abs/2404.05177)<sup>[[存档](https://web.archive.org/web/20241217184935/https://arxiv.org/abs/2404.05177)]</sup>. FOCS 2024.
2. Alin Bostan, Ryuhei Mori.[A Simple and Fast Algorithm for Computing the N-th Term of a Linearly Recurrent Sequence](https://arxiv.org/abs/2008.08822)<sup>[[存档](https://web.archive.org/web/20240829093607/https://arxiv.org/abs/2008.08822)]</sup>. SOSA 2021: 118-132
3. R. P. Brent and H. T. Kung. 1978.[Fast Algorithms for Manipulating Formal Power Series](https://doi.org/10.1145/322092.322099)<sup>[[存档](https://web.archive.org/web/20211021071546/https://doi.org/10.1145/322092.322099)]</sup>. J. ACM 25, 4 (Oct. 1978), 581–595.
4. Daniel J. Bernstein. "[Fast multiplication and its applications](https://cr.yp.to/papers.html#multapps)<sup>[[存档](https://web.archive.org/web/20211208043948/https://cr.yp.to/papers.html#multapps)]</sup>." Pages 325–384 in Algorithmic number theory: lattices, number fields, curves and cryptography, edited by Joe Buhler, Peter Stevenhagen, Cambridge University Press, 2008, ISBN 978-0521808545.
