...
直接用递推式计算前 $n$ 项是 $O(n^2)$ 的，[运用 FFT](./elementary-func.md#%E5%A4%9A%E9%A1%B9%E5%BC%8F%E6%B1%82%E9%80%86) 可得到 $O(n\log n)$ 的算法。
...
[HALF-GCD](https://loj.ac/p/172)<sup>[[存档](https://web.archive.org/web/20220926051158/https://loj.ac/p/172)]</sup> 允许我们在 $O(n\log^2 n)$ 时间内计算多项式欧几里得。
...
- [**Picks's Blog**](https://picks.logdown.com)<sup>[[存档](https://web.archive.org/web/20250428012405/https://picks.logdown.com)]</sup>
- [**Miskcoo's Space**](https://blog.miskcoo.com)<sup>[[存档](https://web.archive.org/web/20171208113058/https://blog.miskcoo.com)]</sup>
- [**Polynomial ring - Wikipedia**](https://en.wikipedia.org/wiki/Polynomial_ring)<sup>[[存档](https://web.archive.org/web/20241222152116/https://en.wikipedia.org/wiki/Polynomial_ring)]</sup>
- [**Formal power series - Wikipedia**](https://en.wikipedia.org/wiki/Formal_power_series#The_ring_of_formal_power_series)<sup>[[存档](https://web.archive.org/web/20211231191021/https://en.wikipedia.org/wiki/Formal_power_series#The_ring_of_formal_power_series)]</sup>
- 《信息学竞赛中的生成函数计算理论框架》
