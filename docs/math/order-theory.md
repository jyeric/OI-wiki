...
Zorn 引理与 **[选择公理](https://en.wikipedia.org/wiki/Axiom_of_choice)<sup>[[存档](https://web.archive.org/web/20250904011654/https://en.wikipedia.org/wiki/Axiom_of_choice)]</sup>**、**[良序定理](https://en.wikipedia.org/wiki/Well-ordering_theorem)<sup>[[存档](https://web.archive.org/web/20241218115128/https://en.wikipedia.org/wiki/Well-ordering_theorem)]</sup>** 等价。
...
Dilworth 定理与 [Hall 婚配定理](../graph/graph-matching/graph-match.md#hall-%E5%AE%9A%E7%90%86) 等价。
...
???+ note "[Luogu P1020 \[NOIP1999 提高组\] 导弹拦截](https://www.luogu.com.cn/problem/P1020)"
    ...
    ??? note "题解"
        ...
        进而根据 Dilworth 定理有：**序列的不上升子序列的最少覆盖数等于最长上升子序列长度**。从而可以通过 [最长不下降子序列的 $O(n\log n)$ 做法](../dp/basic.md#%E7%AE%97%E6%B3%95%E4%BA%8C) 解决本题。
...
- [[CTSC2008] 祭祀](https://www.luogu.com.cn/problem/P4298)<sup>[[存档](https://web.archive.org/web/20241205010008/https://www.luogu.com.cn/problem/P4298)]</sup>
- [CodeForces 590E Birthday](https://codeforces.com/problemset/problem/590/E)<sup>[[存档](https://web.archive.org/web/20200928195806/https://codeforces.com/problemset/problem/590/E)]</sup>
...
C++ STL 中 [需要使用比较的算法和数据结构](https://en.cppreference.com/w/cpp/named_req/Compare#Standard_library)<sup>[[存档](https://web.archive.org/web/20180618183107/https://en.cppreference.com/w/cpp/named_req/Compare#Standard_library)]</sup> 中有序理论的应用。我们经常需要在 C++ 中自定义比较器，STL [要求](https://en.cppreference.com/w/cpp/named_req/Compare)<sup>[[存档](https://web.archive.org/web/20211019203037/https://en.cppreference.com/w/cpp/named_req/Compare)]</sup> 其必须为 **严格弱序**。令 $<$ 为自定义比较器，则可以定义：
...
1. [Order theory - From Academic Kids](https://academickids.com/encyclopedia/index.php/Order_theory)<sup>[[存档](https://web.archive.org/web/20230307050203/https://academickids.com/encyclopedia/index.php/Order_theory)]</sup>
2. [Binary Relation - Wikipedia](https://en.wikipedia.org/wiki/Binary_relation)<sup>[[存档](https://web.archive.org/web/20221229224658/https://en.wikipedia.org/wiki/Binary_relation)]</sup>
3. [Order Theory - Wikipedia](https://en.wikipedia.org/wiki/Order_theory)<sup>[[存档](https://web.archive.org/web/20101103125808/https://en.wikipedia.org/wiki/Order_theory)]</sup>
4. [Hasse diagram - Wikipedia](https://en.wikipedia.org/wiki/Hasse_diagram)<sup>[[存档](https://web.archive.org/web/20241217204539/https://en.wikipedia.org/wiki/Hasse_diagram)]</sup>
5. [Directed set - Wikipedia](https://en.wikipedia.org/wiki/Directed_set)<sup>[[存档](https://web.archive.org/web/20041130233017/https://en.wikipedia.org/wiki/Directed_set)]</sup>
6. [Order Theory, Lecture Notes by Mark Dean for Decision Theory](http://www.columbia.edu/~md3405/DT_Order_15.pdf)<sup>[[存档](https://web.archive.org/web/20250812184759/http://www.columbia.edu/~md3405/DT_Order_15.pdf)]</sup>
7. 卢开澄，卢华明，[《组合数学》（第 3 版）](http://www.tup.tsinghua.edu.cn/bookscenter/book_00458101.html)<sup>[[存档](https://web.archive.org/web/20211026201325/http://www.tup.tsinghua.edu.cn/bookscenter/book_00458101.html)]</sup>, 2006
8. [List of Order Theory Topics - Wikipedia](https://en.wikipedia.org/wiki/List_of_order_theory_topics)<sup>[[存档](https://web.archive.org/web/20180928000408/https://en.wikipedia.org/wiki/List_of_order_theory_topics)]</sup>
9. [浅谈邻项交换排序的应用以及需要注意的问题 by ouuan](https://ouuan.github.io/post/%E6%B5%85%E8%B0%88%E9%82%BB%E9%A1%B9%E4%BA%A4%E6%8D%A2%E6%8E%92%E5%BA%8F%E7%9A%84%E5%BA%94%E7%94%A8%E4%BB%A5%E5%8F%8A%E9%9C%80%E8%A6%81%E6%B3%A8%E6%84%8F%E7%9A%84%E9%97%AE%E9%A2%98/)<sup>[[存档](https://web.archive.org/web/20221014111623/https://ouuan.github.io/post/%E6%B5%85%E8%B0%88%E9%82%BB%E9%A1%B9%E4%BA%A4%E6%8D%A2%E6%8E%92%E5%BA%8F%E7%9A%84%E5%BA%94%E7%94%A8%E4%BB%A5%E5%8F%8A%E9%9C%80%E8%A6%81%E6%B3%A8%E6%84%8F%E7%9A%84%E9%97%AE%E9%A2%98/)]</sup>
10. [One thing you should know about comparators—Strict Weak Ordering](https://codeforces.com/blog/entry/72525)<sup>[[存档](https://web.archive.org/web/20191228025119/https://codeforces.com/blog/entry/72525)]</sup>
11. [Dilworth's theorem - Wikipedia](https://en.wikipedia.org/wiki/Dilworth%27s_theorem)<sup>[[存档](https://web.archive.org/web/20161121013324/https://en.wikipedia.org/wiki/Dilworth%27s_theorem)]</sup>
12. [Dilworth's Theorem | Brilliant Math & Science Wiki](https://brilliant.org/wiki/dilworths-theorem/)<sup>[[存档](https://web.archive.org/web/20230608081337/https://brilliant.org/wiki/dilworths-theorem/)]</sup>
13. [Hall's marriage theorem - Wikipedia](https://en.wikipedia.org/wiki/Hall%27s_marriage_theorem)<sup>[[存档](https://web.archive.org/web/20250822201829/https://en.wikipedia.org/wiki/Hall%27s_marriage_theorem)]</sup>
14. [Hall's Marriage Theorem | Brilliant Math & Science Wiki](https://brilliant.org/wiki/hall-marriage-theorem/)<sup>[[存档](https://web.archive.org/web/20221225083922/https://brilliant.org/wiki/hall-marriage-theorem/)]</sup>
15. [Dilworth 学习笔记 - Selfish](https://www.luogu.com.cn/blog/Rolling-Code/dilworth)<sup>[[存档](https://web.archive.org/web/20220725023946/https://www.luogu.com.cn/blog/Rolling-Code/dilworth)]</sup>
