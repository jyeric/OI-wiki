...
这种插值方式叫做 [线性插值](https://en.wikipedia.org/wiki/Linear_interpolation)<sup>[[存档](https://web.archive.org/web/20211229192513/https://en.wikipedia.org/wiki/Linear_interpolation)]</sup>。
...
这种插值方式叫做 [多项式插值](https://en.wikipedia.org/wiki/Polynomial_interpolation)<sup>[[存档](https://web.archive.org/web/20211130010233/https://en.wikipedia.org/wiki/Polynomial_interpolation)]</sup>。
...
朴素实现的时间复杂度为 $O(n^2)$，可以优化到 $O(n\log^2 n)$，参见 [多项式快速插值](../poly/multipoint-eval-interpolation.md#%E5%A4%9A%E9%A1%B9%E5%BC%8F%E7%9A%84%E5%BF%AB%E9%80%9F%E6%8F%92%E5%80%BC)。
...
自 C++ 20 起，标准库添加了 [`std::midpoint`](https://en.cppreference.com/w/cpp/numeric/midpoint)<sup>[[存档](https://web.archive.org/web/20211208111809/https://en.cppreference.com/w/cpp/numeric/midpoint)]</sup> 和 [`std::lerp`](https://en.cppreference.com/w/cpp/numeric/lerp)<sup>[[存档](https://web.archive.org/web/20220926064623/https://en.cppreference.com/w/cpp/numeric/lerp)]</sup> 函数，分别用于求中点和线性插值。


## 习题


- [「NOIP2020」微信步数](https://loj.ac/p/3389)<sup>[[存档](https://web.archive.org/web/20240912182022/https://loj.ac/p/3389)]</sup>
- [「联合省选 2022」填树](https://loj.ac/p/3701)<sup>[[存档](https://web.archive.org/web/20250417184224/https://loj.ac/p/3701)]</sup>
- [「NOI2019」机器人](https://loj.ac/p/3157)<sup>[[存档](https://web.archive.org/web/20250909081551/https://loj.ac/p/3157)]</sup>

## 参考资料


1. [Interpolation - Wikipedia](https://en.wikipedia.org/wiki/Interpolation)<sup>[[存档](https://web.archive.org/web/20231217075325/https://en.wikipedia.org/wiki/Interpolation)]</sup>
2. [Newton polynomial - Wikipedia](https://en.wikipedia.org/wiki/Newton_polynomial)<sup>[[存档](https://web.archive.org/web/20180627091929/https://en.wikipedia.org/wiki/Newton_polynomial)]</sup>
