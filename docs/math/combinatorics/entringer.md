...
恩特林格数（Entringer number，[OEIS A008281](http://oeis.org/A008281)<sup>[[存档](https://web.archive.org/web/20121202150102/http://oeis.org/A008281)]</sup>）$E(n,k)$ 是满足下述条件的 $0$ 到 $n$ 共 $n+1$ 个数的置换数目：
...
恩特林格数的一个适当排列的数字三角，称为 Seidel–Entringer–Arnold 三角（Seidel–Entringer–Arnold triangle，[OEIS A008280](http://oeis.org/A008280)<sup>[[存档](https://web.archive.org/web/20211224123808/http://oeis.org/A008280)]</sup>）。该三角是按照「牛耕」顺序（ox-plowing order）排列的恩特林格数 $E_(n,k)$：
...
对于 zigzag 置换的个数 $Z_n$（[OEIS A001250](http://oeis.org/A001250)<sup>[[存档](https://web.archive.org/web/20230928074032/http://oeis.org/A001250)]</sup>），从 $n=0$ 开始有：
...
这里的 $A_n$ 称为 zigzag 数（Euler zigzag number，[OEIS A000111](http://oeis.org/A000111)<sup>[[存档](https://web.archive.org/web/20181211124717/http://oeis.org/A000111)]</sup>），从 $n=0$ 开始有：
...
前几项为（[OEIS A000364](http://oeis.org/A000364)<sup>[[存档](https://web.archive.org/web/20250628034701/http://oeis.org/A000364)]</sup>）：
...
前几项为（[OEIS A000182](http://oeis.org/A000182)<sup>[[存档](https://web.archive.org/web/20221208063436/http://oeis.org/A000182)]</sup>）：
...
1. [Alternating permutation - Wikipedia](https://en.wikipedia.org/wiki/Alternating_permutation)<sup>[[存档](https://web.archive.org/web/20241225010736/https://en.wikipedia.org/wiki/Alternating_permutation)]</sup>
