...
这其实是 $x$ 的 $n$ 次上升阶乘幂，记做 $x^{\overline n}$。这个东西自然是可以暴力分治乘 $O(n\log^2n)$ 求出的，但用上升幂相关做法可以 $O(n\log n)$ 求出，详情见 [多项式平移 | 连续点值平移](../poly/shift.md#%E5%90%8C%E4%B8%80%E8%A1%8C%E7%AC%AC%E4%B8%80%E7%B1%BB%E6%97%A0%E7%AC%A6%E5%8F%B7-stirling-%E6%95%B0)。
...
- [HDU3625 Examining the Rooms](https://acm.hdu.edu.cn/showproblem.php?pid=3625)<sup>[[存档](https://web.archive.org/web/20240921022619/https://acm.hdu.edu.cn/showproblem.php?pid=3625)]</sup>
- [UOJ540 联合省选 2020 组合数问题](https://uoj.ac/problem/540)<sup>[[存档](https://web.archive.org/web/20211018200114/https://uoj.ac/problem/540)]</sup>
- [UOJ269 清华集训 2016 如何优雅地求和](https://uoj.ac/problem/269)<sup>[[存档](https://web.archive.org/web/20250616190959/https://uoj.ac/problem/269)]</sup>

## 参考资料与注释


1. [Stirling Number of the First Kind - Wolfram MathWorld](http://mathworld.wolfram.com/StirlingNumberoftheFirstKind.html)<sup>[[存档](https://web.archive.org/web/20241231094652/http://mathworld.wolfram.com/StirlingNumberoftheFirstKind.html)]</sup>
2. [Stirling Number of the Second Kind - Wolfram MathWorld](http://mathworld.wolfram.com/StirlingNumberoftheSecondKind.html)<sup>[[存档](https://web.archive.org/web/20191208134807/http://mathworld.wolfram.com/StirlingNumberoftheSecondKind.html)]</sup>
