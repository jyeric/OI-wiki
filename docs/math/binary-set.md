...
**本页面主要译自博文 [Перебор всех подмасок данной маски](http://e-maxx.ru/algo/all_submasks)<sup>[[存档](https://web.archive.org/web/20120921023118/http://e-maxx.ru/algo/all_submasks)]</sup> 与其英文翻译版 [Submask Enumeration](https://cp-algorithms.com/algebra/all-submasks.html)<sup>[[存档](https://web.archive.org/web/20220927201900/https://cp-algorithms.com/algebra/all-submasks.html)]</sup>。其中俄文版版权协议为 Public Domain + Leave a Link；英文版版权协议为 CC-BY-SA 4.0。**


### 习题


- [Atcoder - Close Group](https://atcoder.jp/contests/abc187/tasks/abc187_f)<sup>[[存档](https://web.archive.org/web/20210730073215/https://atcoder.jp/contests/abc187/tasks/abc187_f)]</sup>
- [Codeforces - Nuclear Fusion](http://codeforces.com/problemset/problem/71/E)<sup>[[存档](https://web.archive.org/web/20230403113737/http://codeforces.com/problemset/problem/71/E)]</sup>
- [Codeforces - Sandy and Nuts](http://codeforces.com/problemset/problem/599/E)<sup>[[存档](https://web.archive.org/web/20200920152730/http://codeforces.com/problemset/problem/599/E)]</sup>
