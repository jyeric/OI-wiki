...
求解逆元，就相当于求解线性同余方程。因此，可以使用 [扩展欧几里得算法](./gcd.md#%E6%89%A9%E5%B1%95%E6%AC%A7%E5%87%A0%E9%87%8C%E5%BE%97%E7%AE%97%E6%B3%95) 在 $O(\log\min{a,m})$ 时间内求解逆元。同时，由于逆元对应的线性方程比较特殊，可以适当地简化相应的步骤。
...
这一方法主要适用于模数是素数 $p$ 的情形。此时，由 [费马小定理](./fermat.md#%E8%B4%B9%E9%A9%AC%E5%B0%8F%E5%AE%9A%E7%90%86) 可知对于任意 $a\perp p$ 都有
...
当然，理论上，这一方法可以利用 [欧拉定理](./fermat.md#%E6%AC%A7%E6%8B%89%E5%AE%9A%E7%90%86) 推广到一般的模数 $m$ 的情形，即利用 $a^{\varphi(m)-1}\bmod m$ 计算逆元。但是，单次求解 [欧拉函数](./euler-totient.md) $\varphi(m)$ 并不容易，因此该算法在一般情况下效率不高。
...
- [LOJ 110 乘法逆元](https://loj.ac/problem/110)<sup>[[存档](https://web.archive.org/web/20220819143904/https://loj.ac/problem/110)]</sup>
- [LOJ 161 乘法逆元 2](https://loj.ac/problem/161)<sup>[[存档](https://web.archive.org/web/20210411004234/https://loj.ac/problem/161)]</sup>
- [LOJ 2605「NOIP2012」同余方程](https://loj.ac/problem/2605)<sup>[[存档](https://web.archive.org/web/20250212113559/https://loj.ac/problem/2605)]</sup>
- [Luogu P2054「AHOI2005」洗牌](https://www.luogu.com.cn/problem/P2054)<sup>[[存档](https://web.archive.org/web/20250824191924/https://www.luogu.com.cn/problem/P2054)]</sup>
- [LOJ 2034「SDOI2016」排列计数](https://loj.ac/problem/2034)<sup>[[存档](https://web.archive.org/web/20240222210315/https://loj.ac/problem/2034)]</sup>

## 参考资料与注释


- [Modular multiplicative inverse - Wikipedia](https://en.wikipedia.org/wiki/Modular_multiplicative_inverse)<sup>[[存档](https://web.archive.org/web/20221220083546/https://en.wikipedia.org/wiki/Modular_multiplicative_inverse)]</sup>
