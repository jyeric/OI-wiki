...
**费马小定理**（Fermat's little theorem）是数论中最基础的定理之一。它也是 [Fermat 素性测试](./prime.md#fermat-%E7%B4%A0%E6%80%A7%E6%B5%8B%E8%AF%95) 的理论基础。
...
费马小定理的逆命题并不成立。即使对于所有与 $n$ 互素的 $a$，都有 $a^{n-1}\equiv 1\pmod n$，那么，$n$ 也未必是素数。相关讨论详见 [Fermat 素性测试](./prime.md#fermat-%E7%B4%A0%E6%80%A7%E6%B5%8B%E8%AF%95) 一节。
...
??? note "证明"
    ...
    这是模 $m$ 的 [既约剩余系](./basic.md#%E5%90%8C%E4%BD%99%E7%B1%BB%E4%B8%8E%E5%89%A9%E4%BD%99%E7%B3%BB)。根据欧拉函数的定义可知，$|R|=\varphi(m)$。类似上文，将它们乘以 $a$ 相当于对该集合重新排列：
...
对于素数 $p$，有 $\varphi(p)=p-1$，因此，费马小定理是欧拉定理的一个特例。另外，欧拉定理中的指数 $\varphi(m)$ 在一般情形下并非使得该式成立的最小指数。它可以改进到 $\lambda(m)$，其中，$\lambda(\cdot)$ 是 [Carmichael 函数](./prime.md#carmichael-%E5%87%BD%E6%95%B0)。关于相关结论的代数背景，可以参考 [整数同余类的乘法群](../algebra/ring-theory.md#%E5%BA%94%E7%94%A8%E6%95%B4%E6%95%B0%E5%90%8C%E4%BD%99%E7%B1%BB%E7%9A%84%E4%B9%98%E6%B3%95%E7%BE%A4) 一节。
...
本节通过一道例题展示扩展欧拉定理的一个经典应用——计算任意模数下的幂塔。**幂塔**（power tower）指形如 $A\uparrow(B\uparrow(C\uparrow(D\uparrow\cdots)))$ 的式子，其中，$\uparrow$ 是 [Knuth 箭头记号](https://en.wikipedia.org/wiki/Knuth%27s_up-arrow_notation)<sup>[[存档](https://web.archive.org/web/20121114010542/https://en.wikipedia.org/wiki/Knuth%27s_up-arrow_notation)]</sup>，即 $A\uparrow B$ 表示幂 $A^B$，而 $A,B,C,D,\cdots$ 是一系列非负整数。
...
- [Luogu P5091【模板】扩展欧拉定理](https://www.luogu.com.cn/problem/P5091)<sup>[[存档](https://web.archive.org/web/20231010141851/https://www.luogu.com.cn/problem/P5091)]</sup>
- [Codeforces 906 D. Power Tower](https://codeforces.com/problemset/problem/906/D)<sup>[[存档](https://web.archive.org/web/20231208060335/https://codeforces.com/problemset/problem/906/D)]</sup>
- [Luogu P3747 [六省联考 2017] 相逢是问候](https://www.luogu.com.cn/problem/P3747)<sup>[[存档](https://web.archive.org/web/20250424234258/https://www.luogu.com.cn/problem/P3747)]</sup>
- [Luogu P4139 上帝与集合的正确用法](https://www.luogu.com.cn/problem/P4139)<sup>[[存档](https://web.archive.org/web/20211211012246/https://www.luogu.com.cn/problem/P4139)]</sup>
- [Luogu P3934 [Ynoi Easy Round 2016] 炸脖龙 I](https://www.luogu.com.cn/problem/P3934)<sup>[[存档](https://web.archive.org/web/20240726134210/https://www.luogu.com.cn/problem/P3934)]</sup>
- [Luogu P6736「Wdsr-2」白泽教育](https://www.luogu.com.cn/problem/P6736)<sup>[[存档](https://web.archive.org/web/20240113105650/https://www.luogu.com.cn/problem/P6736)]</sup>

## 参考资料与注释


- [Fermat's little theorem - Wikipedia](https://en.wikipedia.org/wiki/Fermat%27s_little_theorem)<sup>[[存档](https://web.archive.org/web/20231223225837/https://en.wikipedia.org/wiki/Fermat%27s_little_theorem)]</sup>
- [Euler's theorem - Wikipedia](https://en.wikipedia.org/wiki/Euler%27s_theorem)<sup>[[存档](https://web.archive.org/web/20250910155321/https://en.wikipedia.org/wiki/Euler%27s_theorem)]</sup>
