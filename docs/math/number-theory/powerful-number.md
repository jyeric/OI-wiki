...
### [Luogu P5325【模板】Min_25 筛](https://www.luogu.com.cn/problem/P5325)<sup>[[存档](https://web.archive.org/web/20211028055142/https://www.luogu.com.cn/problem/P5325)]</sup>
...
考虑使用杜教筛求 $G(n)$，根据 $(\operatorname{id}\cdot \varphi) * \operatorname{id} = \operatorname{id}*2$ 可得 $G(n)= \sum*{i=1}^{n} i^2 - \sum_{d=2}^{n} d \cdot G\left(\left\lfloor \dfrac{n}{d} \right\rfloor\right)$。
...
### [「LOJ #6053」简单的函数](https://loj.ac/problem/6053)<sup>[[存档](https://web.archive.org/web/20250323155740/https://loj.ac/problem/6053)]</sup>
...
- [PE708 Twos are all you need](https://projecteuler.net/problem=708)<sup>[[存档](https://web.archive.org/web/20220628150754/https://projecteuler.net/problem=708)]</sup>
- [PE639 Summing a multiplicative function](https://projecteuler.net/problem=639)<sup>[[存档](https://web.archive.org/web/20210731154400/https://projecteuler.net/problem=639)]</sup>
- [PE484 Arithmetic Derivative](https://projecteuler.net/problem=484)<sup>[[存档](https://web.archive.org/web/20241227054828/https://projecteuler.net/problem=484)]</sup>

## 参考资料


- [破壁人五号 - Powerful number 筛略解](https://www.cnblogs.com/wallbreaker5th/p/13901487.html)<sup>[[存档](https://web.archive.org/web/20221205185421/https://www.cnblogs.com/wallbreaker5th/p/13901487.html)]</sup>
- [command_block - 杜教筛（+ 贝尔级数 + powerful number）](https://www.luogu.com.cn/blog/command-block/du-jiao-shai)<sup>[[存档](https://web.archive.org/web/20240118075842/https://www.luogu.com.cn/blog/command-block/du-jiao-shai)]</sup>
