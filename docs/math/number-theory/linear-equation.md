...
本文接下来介绍了两种求解线性同余方程的思路，分别利用了逆元和不定方程。对于一般的情形，逆元和不定方程的求解都需要用到 [扩展欧几里得算法](./gcd.md#%E6%89%A9%E5%B1%95%E6%AC%A7%E5%87%A0%E9%87%8C%E5%BE%97%E7%AE%97%E6%B3%95)，因此，这两种思路其实是一致的。
...
线性同余方程等价于关于 $x,y$ 的 [二元一次不定方程](./bezouts.md#%E4%B8%A4%E4%B8%AA%E5%8F%98%E9%87%8F%E7%9A%84%E6%83%85%E5%BD%A2)：
...
- [「NOIP2012」同余方程](https://loj.ac/problem/2605)<sup>[[存档](https://web.archive.org/web/20250212113559/https://loj.ac/problem/2605)]</sup>

**本页面主要译自博文 [Модульное линейное уравнение первого порядка](http://e-maxx.ru/algo/diofant_1_equation)<sup>[[存档](https://web.archive.org/web/20221205141517/http://e-maxx.ru/algo/diofant_1_equation)]</sup> 与其英文翻译版 [Linear Congruence Equation](https://cp-algorithms.com/algebra/linear_congruence_equation.html)<sup>[[存档](https://web.archive.org/web/20250825203315/https://cp-algorithms.com/algebra/linear_congruence_equation.html)]</sup>。其中俄文版版权协议为 Public Domain + Leave a Link；英文版版权协议为 CC-BY-SA 4.0。内容有改动。**
