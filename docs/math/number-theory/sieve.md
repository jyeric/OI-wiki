...
参见 [bitset: 与埃氏筛结合](../../lang/csl/bitset.md#%E4%B8%8E%E5%9F%83%E6%B0%8F%E7%AD%9B%E7%BB%93%E5%90%88)。
...
假如一个 [积性函数](./basic.md#%E7%A7%AF%E6%80%A7%E5%87%BD%E6%95%B0)  $f$ 满足：对于任意质数 $p$ 和正整数 $k$，可以在关于 $k$ 的低次多项式时间内计算 $f(p^k)$，那么可以在 $O(n)$ 时间内筛出 $f(1),f(2),\dots,f(n)$ 的值。
...
**本节部分内容译自博文 [Решето Эратосфена](http://e-maxx.ru/algo/eratosthenes_sieve)<sup>[[存档](https://web.archive.org/web/20250426002239/http://e-maxx.ru/algo/eratosthenes_sieve)]</sup> 与其英文翻译版 [Sieve of Eratosthenes](https://cp-algorithms.com/algebra/sieve-of-eratosthenes.html)<sup>[[存档](https://web.archive.org/web/20210924052045/https://cp-algorithms.com/algebra/sieve-of-eratosthenes.html)]</sup>。其中俄文版版权协议为 Public Domain + Leave a Link；英文版版权协议为 CC-BY-SA 4.0。**
