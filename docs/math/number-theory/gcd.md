...
最大公约数与最小公倍数的性质见 [数论基础](./basic.md#%E6%9C%80%E5%A4%A7%E5%85%AC%E7%BA%A6%E6%95%B0%E4%B8%8E%E6%9C%80%E5%B0%8F%E5%85%AC%E5%80%8D%E6%95%B0)。
...
另外，对于 C++17，我们可以使用 [`<numeric>`](https://en.cppreference.com/w/cpp/header/numeric)<sup>[[存档](https://web.archive.org/web/20231210203406/https://en.cppreference.com/w/cpp/header/numeric)]</sup> 头中的 [`std::gcd`](https://en.cppreference.com/w/cpp/numeric/gcd)<sup>[[存档](https://web.archive.org/web/20231202030826/https://en.cppreference.com/w/cpp/numeric/gcd)]</sup> 与 [`std::lcm`](https://en.cppreference.com/w/cpp/numeric/lcm)<sup>[[存档](https://web.archive.org/web/20181210070139/https://en.cppreference.com/w/cpp/numeric/lcm)]</sup> 来求最大公约数和最小公倍数。
...
???+ note "关于 countr_zero"
    ...
    1. gcc 有 [内建函数](../bit.md#%E5%86%85%E5%BB%BA%E5%87%BD%E6%95%B0) `__builtin_ctz`（32 位）或 `__builtin_ctzll`（64 位）可替换上述代码的 `countr_zero`；
    2. 从 C++20 开始，头文件 `<bit>` 包含了 [`std::countr_zero`](https://en.cppreference.com/w/cpp/numeric/countr_zero)<sup>[[存档](https://web.archive.org/web/20201114100248/https://en.cppreference.com/w/cpp/numeric/countr_zero)]</sup>；
...
更多关于 `gcd` 实现上快慢的讨论可阅读 [Fastest way to compute the greatest common divisor](https://lemire.me/blog/2013/12/26/fastest-way-to-compute-the-greatest-common-divisor/)<sup>[[存档](https://web.archive.org/web/20250816191443/https://lemire.me/blog/2013/12/26/fastest-way-to-compute-the-greatest-common-divisor/)]</sup>。
...
- [10104 - Euclid Problem](https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=1045)<sup>[[存档](https://web.archive.org/web/20220707205931/https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=1045)]</sup>
- [GYM - (J) once upon a time](http://codeforces.com/gym/100963)<sup>[[存档](https://web.archive.org/web/20210818092310/http://codeforces.com/gym/100963)]</sup>
- [UVa - 12775 - Gift Dilemma](https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=4628)<sup>[[存档](https://web.archive.org/web/20220707205931/https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=4628)]</sup>
