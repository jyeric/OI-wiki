...
???+ abstract "引理"
    ...
    ???+ note "证明"
        ...
        令 $m=\left\lfloor\dfrac{n}{x}\right\rfloor$, 任取 $\left\lfloor\dfrac{m}{y}\right\rfloor \in R(m)$, 由整除分块/数论分块的 [引理 1](./sqrt-decomposition.md#%E5%BC%95%E7%90%86-1) 可知：
...
=== "莫比乌斯函数前缀和"
    ...
    时间复杂度的推导见 [时间复杂度](#%E6%97%B6%E9%97%B4%E5%A4%8D%E6%9D%82%E5%BA%A6) 一节。
...
2. [杜教筛的时空复杂度分析 - riteme.site](https://riteme.site/blog/2018-9-11/time-space-complexity-dyh-algo.html)<sup>[[存档](https://web.archive.org/web/20240423030452/https://riteme.site/blog/2018-9-11/time-space-complexity-dyh-algo.html)]</sup>
