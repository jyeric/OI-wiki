...
本文翻译自：[Computing $\pi(x)$: the Meissel, Lehmer, Lagarias, Miller, Odlyzko method](https://dl.acm.org/doi/abs/10.1090/s0025-5718-96-00674-6)<sup>[[存档](https://web.archive.org/web/20240604204102/https://dl.acm.org/doi/abs/10.1090/s0025-5718-96-00674-6)]</sup>
