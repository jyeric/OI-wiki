...
规模不大时，组合数可以通过 [递推公式](../combinatorics/combination.md#%E7%BB%84%E5%90%88%E6%95%B0%E6%80%A7%E8%B4%A8--%E4%BA%8C%E9%A1%B9%E5%BC%8F%E6%8E%A8%E8%AE%BA) 求解，时间复杂度为 $O(nk)$；也可以在较大的素数模数 $p>n$ 下，通过计算分子和分母的阶乘在 $O(n)$ 时间内求解。但当问题规模很大（$n\sim 10^{18}$）时，这些方法不再适用。
...
??? note "利用生成函数证明"
    ...
    记 $f(x) = ax^n + bx^m$。一般地，由 [二项式展开](../combinatorics/combination.md#%E4%BA%8C%E9%A1%B9%E5%BC%8F%E5%AE%9A%E7%90%86) 和 [费马小定理](./fermat.md#%E8%B4%B9%E9%A9%AC%E5%B0%8F%E5%AE%9A%E7%90%86) 有
...
??? note "利用阶乘取模的结论证明"
    ...
    此处提供一种基于 [阶乘取模](./factorial.md#%E7%B4%A0%E6%95%B0%E6%A8%A1%E7%9A%84%E6%83%85%E5%BD%A2) 相关结论的证明方法，以方便和后文 exLucas 部分的方法建立联系。已知二项式系数
...
式子中的 $\nu_p(n!)$ 等可以通过 [Legendre 公式](./factorial.md#legendre-%E5%85%AC%E5%BC%8F) 计算，$(n!)_p$ 等则可以通过 [递推关系](./factorial.md#%E7%B4%A0%E6%95%B0%E5%B9%82%E6%A8%A1%E7%9A%84%E6%83%85%E5%BD%A2) 计算。因为后者与 $p^\alpha$ 互素，所以分母上的乘积的逆元可以通过 [扩展欧几里得算法](./inverse.md#%E6%89%A9%E5%B1%95%E6%AC%A7%E5%87%A0%E9%87%8C%E5%BE%97%E7%AE%97%E6%B3%95) 计算。问题就得以解决。
...
最后，给出模板题目 [二项式系数](https://loj.ac/p/181)<sup>[[存档](https://web.archive.org/web/20240526034647/https://loj.ac/p/181)]</sup> 的参考实现。
...
- [Luogu3807【模板】卢卡斯定理](https://www.luogu.com.cn/problem/P3807)<sup>[[存档](https://web.archive.org/web/20210728035744/https://www.luogu.com.cn/problem/P3807)]</sup>
- [SDOI2010 古代猪文  卢卡斯定理](https://loj.ac/problem/10229)<sup>[[存档](https://web.archive.org/web/20220609140557/https://loj.ac/problem/10229)]</sup>
- [Luogu4720【模板】扩展卢卡斯](https://www.luogu.com.cn/problem/P4720)<sup>[[存档](https://web.archive.org/web/20241207110414/https://www.luogu.com.cn/problem/P4720)]</sup>
- [Ceizenpok’s formula](http://codeforces.com/gym/100633/problem/J)<sup>[[存档](https://web.archive.org/web/20221224153543/http://codeforces.com/gym/100633/problem/J)]</sup>
