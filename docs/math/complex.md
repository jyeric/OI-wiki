...
若取 $z\in\mathbf{R}$，则由 [欧拉公式](#%E6%AC%A7%E6%8B%89%E5%85%AC%E5%BC%8F) 有：
...
- [Complex number - Wikipedia](https://en.wikipedia.org/wiki/Complex_number)<sup>[[存档](https://web.archive.org/web/20241229100308/https://en.wikipedia.org/wiki/Complex_number)]</sup>
- [Euler's formula - Wikipedia](https://en.wikipedia.org/wiki/Euler%27s_formula)<sup>[[存档](https://web.archive.org/web/20191230001855/https://en.wikipedia.org/wiki/Euler%27s_formula)]</sup>
- [Complex number arithmetic - cppreference.com](https://en.cppreference.com/w/c/numeric/complex)<sup>[[存档](https://web.archive.org/web/20241217071045/https://en.cppreference.com/w/c/numeric/complex)]</sup>
- [std::complex - cppreference.com](https://en.cppreference.com/w/cpp/numeric/complex)<sup>[[存档](https://web.archive.org/web/20231121190049/https://en.cppreference.com/w/cpp/numeric/complex)]</sup>

[^ref1]: 有关欧拉公式的更多介绍，可以参考两个视频：[欧拉公式与初等群论](https://www.bilibili.com/video/BV1fx41187tZ)<sup>[[存档](https://web.archive.org/web/20250903150239/https://www.bilibili.com/video/BV1fx41187tZ)]</sup>、[微分方程概论 - 第五章：在 3.14 分钟内理解 $\mathrm{e}^{\mathrm{i}\pi}$](https://www.bilibili.com/video/BV1G4411D7kZ)<sup>[[存档](https://web.archive.org/web/20220531225157/https://www.bilibili.com/video/BV1G4411D7kZ)]</sup>。
