...
设随机变量 $X$ 的分布函数为 $F(x)$，若 [Stieltjes 积分](https://en.wikipedia.org/wiki/Riemann%E2%80%93Stieltjes_integral)<sup>[[存档](https://web.archive.org/web/20131205030203/https://en.wikipedia.org/wiki/Riemann%E2%80%93Stieltjes_integral)]</sup>
