...
位运算的优先级低于算术运算符（除了取反），而按位与、按位或及异或低于比较运算符（详见 [C++ 运算符优先级总表](../lang/op.md#c-%E8%BF%90%E7%AE%97%E7%AC%A6%E4%BC%98%E5%85%88%E7%BA%A7%E6%80%BB%E8%A1%A8)），所以使用时需多加注意，在必要时添加括号。
...
[Luogu P1225 黑白棋游戏](https://www.luogu.com.cn/problem/P1225)<sup>[[存档](https://web.archive.org/web/20231004144432/https://www.luogu.com.cn/problem/P1225)]</sup>


## 参考资料与注释


1. 位运算技巧： <https://graphics.stanford.edu/~seander/bithacks.html><sup>[[存档](https://web.archive.org/web/20131107023310/https://graphics.stanford.edu/~seander/bithacks.html)]</sup>
2. Other Builtins of GCC： <https://gcc.gnu.org/onlinedocs/gcc/Other-Builtins.html><sup>[[存档](https://web.archive.org/web/20231222012059/https://gcc.gnu.org/onlinedocs/gcc/Other-Builtins.html)]</sup>

[^note1]: 适用于 C++14 以前的标准。在 C++14 和 C++17 标准中，若原值为带符号类型，且移位后的结果能被原类型的无符号版本容纳，则将该结果 [转换](../lang/var.md#%E7%B1%BB%E5%9E%8B%E8%BD%AC%E6%8D%A2) 为相应的带符号值，否则行为未定义。在 C++20 标准中，规定了无论是带符号数还是无符号数，左移均直接舍弃移出结果类型的位。
