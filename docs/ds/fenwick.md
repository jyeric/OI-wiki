...
- 例如 $\gcd$，$\max$ 这些信息不可差分，所以不能用普通树状数组处理，但是：
  - 使用两个树状数组可以用于处理区间最值，见 [Efficient Range Minimum Queries using Binary Indexed Trees](http://history.ioinformatics.org/oi/files/volume9.pdf#page=41)<sup>[[存档](https://web.archive.org/web/20250827144623/http://history.ioinformatics.org/oi/files/volume9.pdf#page=41)]</sup>。
...
也有 $\Theta(n)$ 的建树方法，见本页面 [$\Theta(n)$ 建树](#thetan-%E5%BB%BA%E6%A0%91) 一节。
...
前置知识：[前缀和 & 差分](../basic/prefix-sum.md) 和本页面 [区间加区间和](#%E5%8C%BA%E9%97%B4%E5%8A%A0%E5%8C%BA%E9%97%B4%E5%92%8C) 一节。
...
相关阅读和参考实现：[逆序对](../math/permutation.md#%E9%80%86%E5%BA%8F%E6%95%B0)
...
此外，逆序对的计数还可以通过 [归并排序](../basic/merge-sort.md#%E9%80%86%E5%BA%8F%E5%AF%B9) 解决。这一方法可以避免离散化。时间复杂度同样为 $O(n\log n)$。两种算法的参考实现都在 [逆序对](../math/permutation.md#%E9%80%86%E5%BA%8F%E6%95%B0) 章节。
...
???+ note "注"
    ...
    关于这两条性质的含义及证明，都可以在本页面的 [树状数组与其树形态的性质](#%E6%A0%91%E7%8A%B6%E6%95%B0%E7%BB%84%E4%B8%8E%E5%85%B6%E6%A0%91%E5%BD%A2%E6%80%81%E7%9A%84%E6%80%A7%E8%B4%A8) 一节找到。
...
也有 $\Theta(n)$ 的建树方法，见本页面 [$\Theta(n)$ 建树](#thetan-%E5%BB%BA%E6%A0%91) 一节的方法一。
...
- [树状数组 1：单点修改，区间查询](https://loj.ac/problem/130)<sup>[[存档](https://web.archive.org/web/20210518143519/https://loj.ac/problem/130)]</sup>
- [树状数组 2：区间修改，单点查询](https://loj.ac/problem/131)<sup>[[存档](https://web.archive.org/web/20241231195318/https://loj.ac/problem/131)]</sup>
- [树状数组 3：区间修改，区间查询](https://loj.ac/problem/132)<sup>[[存档](https://web.archive.org/web/20191127075303/https://loj.ac/problem/132)]</sup>
- [二维树状数组 1：单点修改，区间查询](https://loj.ac/problem/133)<sup>[[存档](https://web.archive.org/web/20241231195310/https://loj.ac/problem/133)]</sup>
- [二维树状数组 2：区间修改，单点查询](https://loj.ac/problem/134)<sup>[[存档](https://web.archive.org/web/20230529223837/https://loj.ac/problem/134)]</sup>
- [二维树状数组 3：区间修改，区间查询](https://loj.ac/problem/135)<sup>[[存档](https://web.archive.org/web/20220819144744/https://loj.ac/problem/135)]</sup>
