...
每个节点的键值都大于等于其父亲键值的堆叫做小根堆，否则叫做大根堆。[STL 中的 `priority_queue`](../lang/csl/container-adapter.md#%E4%BC%98%E5%85%88%E9%98%9F%E5%88%97) 其实就是一个大根堆。
...
[^ref4]: 表格来自于 [Wikipedia](https://en.wikipedia.org/wiki/Priority_queue#Summary_of_running_times)<sup>[[存档](https://web.archive.org/web/20250908043910/https://en.wikipedia.org/wiki/Priority_queue#Summary_of_running_times)]</sup>
