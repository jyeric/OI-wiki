...
主席树全称是可持久化权值线段树，参见 [知乎讨论](https://www.zhihu.com/question/59195374)<sup>[[存档](https://web.archive.org/web/20220730035920/https://www.zhihu.com/question/59195374)]</sup>。

???+ warning "关于函数式线段树"

    **函数式线段树** 是指使用函数式编程思想的线段树。在函数式编程思想中，将计算机运算视为数学函数，并避免可改变的状态或变量。不难发现，函数式线段树是 [完全可持久化](persistent.md#%E5%AE%8C%E5%85%A8%E5%8F%AF%E6%8C%81%E4%B9%85%E5%8C%96-fully-persistent) 的。
...
<https://en.wikipedia.org/wiki/Persistent_data_structure><sup>[[存档](https://web.archive.org/web/20131111075322/https://en.wikipedia.org/wiki/Persistent_data_structure)]</sup>


<https://www.cnblogs.com/zinthos/p/3899565.html><sup>[[存档](https://web.archive.org/web/20250828115923/https://www.cnblogs.com/zinthos/p/3899565.html)]</sup>
