...
??? note "基于势能分析的复杂度证明"
    ...
    **性质**：
    ...
    接下来，分别对 **zig**、**zig-zig** 和 **zig-zag** 操作进行势能分析。设操作前后的节点 $x$ 的势能分别是 $w(x)$ 和 $w'(x)$。节点的记号与 [上文](#%E4%BC%B8%E5%B1%95%E6%93%8D%E4%BD%9C) 一致。
...
作为例子，本节将讨论模板题目 [普通平衡树](https://loj.ac/problem/104)<sup>[[存档](https://web.archive.org/web/20220618060026/https://loj.ac/problem/104)]</sup> 的实现。
...
分裂操作类似。因而，Splay 树可以模拟 [无旋 treap](./treap.md#%E6%97%A0%E6%97%8B-treap) 的思路做各种操作，包括区间操作。[后文](#%E5%BA%8F%E5%88%97%E6%93%8D%E4%BD%9C) 会介绍更具有 Splay 树风格的区间操作处理方法。
...
本节的最后，给出模板题目 [普通平衡树](https://loj.ac/problem/104)<sup>[[存档](https://web.archive.org/web/20220618060026/https://loj.ac/problem/104)]</sup> 的参考实现。
...
Splay 树也可以运用在序列上，用于维护区间信息。与线段树对比，Splay 树常数较大，但是支持更复杂的序列操作，如区间翻转等。上文提到 Splay 树同样支持分裂和合并操作，因而可以模拟 [无旋 treap](./treap.md#%E6%97%A0%E6%97%8B-treap) 进行区间操作，在此不再过多讨论。本节主要讨论基于伸展操作的区间操作实现方法。
...
作为例子，本节将讨论模板题目 [文艺平衡树](https://loj.ac/problem/105)<sup>[[存档](https://web.archive.org/web/20200921181428/https://loj.ac/problem/105)]</sup> 的实现。
...
本节的最后，给出模板题目 [文艺平衡树](https://loj.ac/problem/105)<sup>[[存档](https://web.archive.org/web/20200921181428/https://loj.ac/problem/105)]</sup> 的参考实现。
...
- [【模板】普通平衡树](https://loj.ac/problem/104)<sup>[[存档](https://web.archive.org/web/20220618060026/https://loj.ac/problem/104)]</sup>
- [【模板】文艺平衡树](https://loj.ac/problem/105)<sup>[[存档](https://web.archive.org/web/20200921181428/https://loj.ac/problem/105)]</sup>
- [「HNOI2002」营业额统计](https://loj.ac/problem/10143)<sup>[[存档](https://web.archive.org/web/20200921193108/https://loj.ac/problem/10143)]</sup>
- [「HNOI2004」宠物收养所](https://loj.ac/problem/10144)<sup>[[存档](https://web.archive.org/web/20250316032730/https://loj.ac/problem/10144)]</sup>

Splay 树还出现在更复杂的应用场景中：


- [「Cerc2007」robotic sort 机械排序](https://www.luogu.com.cn/problem/P4402)<sup>[[存档](https://web.archive.org/web/20221014111629/https://www.luogu.com.cn/problem/P4402)]</sup>
- [「HNOI2011」括号修复/「JSOI2011」括号序列](https://www.luogu.com.cn/problem/P3215)<sup>[[存档](https://web.archive.org/web/20211201133504/https://www.luogu.com.cn/problem/P3215)]</sup>
- [二逼平衡树（树套树）](https://loj.ac/problem/106)<sup>[[存档](https://web.archive.org/web/20241231194919/https://loj.ac/problem/106)]</sup>
- [BZOJ 2827 千山鸟飞绝](https://hydro.ac/p/bzoj-P2827)<sup>[[存档](https://web.archive.org/web/20250121155021/https://hydro.ac/p/bzoj-P2827)]</sup>
- [「Lydsy1706 月赛」K 小值查询](https://hydro.ac/p/bzoj-P4923)<sup>[[存档](https://web.archive.org/web/20250121154406/https://hydro.ac/p/bzoj-P4923)]</sup>
- [POJ3580 SuperMemo](http://poj.org/problem?id=3580)<sup>[[存档](https://web.archive.org/web/20220810211214/http://poj.org/problem?id=3580)]</sup>
