...
此外，对于子树操作，就是要考虑轻儿子的，需要再维护一个包括轻儿子的子树和、子树标记，可以去做 "[P3384【模板】轻重链剖分](https://www.luogu.com.cn/problem/P3384)<sup>[[存档](https://web.archive.org/web/20241008130132/https://www.luogu.com.cn/problem/P3384)]</sup>"。


## 例题


??? note "[P4751【模板】"动态 DP"& 动态树分治（加强版）](https://www.luogu.com.cn/problem/P4751)<sup>[[存档](https://web.archive.org/web/20210615010132/https://www.luogu.com.cn/problem/P4751)]</sup>"
```cpp
#include <algorithm>
#include <cstdio>
#include <cstring>
...
[P4211 [LNOI2014] LCA | 全局平衡二叉树](https://www.luogu.com.cn/blog/nederland/globalbst)<sup>[[存档](https://web.archive.org/web/20240726091451/https://www.luogu.com.cn/blog/nederland/globalbst)]</sup>
