...
???+ warning "关于双下划线开头的库函数"
    ...
    OI 中，关于能否使用双下划线开头的库函数曾经一直不确定，2021 年 CCF 发布的 [关于 NOI 系列活动中编程语言使用限制的补充说明](https://www.noi.cn/xw/2021-09-01/735729.shtml)<sup>[[存档](https://web.archive.org/web/20230329180610/https://www.noi.cn/xw/2021-09-01/735729.shtml)]</sup> 中提到「允许使用以下划线开头的库函数或宏，但具有明确禁止操作的库函数和宏除外」。故 `rope` 目前可以在 OI 中正常使用。
...
[POJ2887 Big String](http://poj.org/problem?id=2887)<sup>[[存档](https://web.archive.org/web/20250811144031/http://poj.org/problem?id=2887)]</sup>
