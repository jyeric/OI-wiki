...
[静态区间 k 小值（POJ 2104 K-th Number）](http://poj.org/problem?id=2104)<sup>[[存档](https://web.archive.org/web/20241231194920/http://poj.org/problem?id=2104)]</sup> 的问题可以用 [权值线段树](./persistent-seg.md) 在 $O(n\log n)$ 的时间复杂度内解决。
