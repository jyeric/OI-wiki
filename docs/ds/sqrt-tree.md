...
给你一个长度为 n 的序列 ${\left\langle a_i\right\rangle}*{i=1}^n$，再给你一个满足结合律的运算 $\circ$（比如 $\gcd,\min,\max,+,\operatorname{and},\operatorname{or},\operatorname{xor}$ 均满足结合律），然后对于每一次区间询问 $[l,r]$，我们需要计算 $a_l\circ a*{l+1}\circ\dotsb\circ a_{r}$。
...
[CodeChef - SEGPROD](https://www.codechef.com/NOV17/problems/SEGPROD)<sup>[[存档](https://web.archive.org/web/20240525060221/https://www.codechef.com/NOV17/problems/SEGPROD)]</sup>


**本页面主要译自 [Sqrt Tree - Algorithms for Competitive Programming](https://cp-algorithms.com/data_structures/sqrt-tree.html)<sup>[[存档](https://web.archive.org/web/20231217170149/https://cp-algorithms.com/data_structures/sqrt-tree.html)]</sup>，版权协议为 CC-BY-SA 4.0。**
