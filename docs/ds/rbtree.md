...
红黑树是 4 阶 B 树（[2-3-4 树](https://en.wikipedia.org/wiki/2%E2%80%933%E2%80%934_tree)<sup>[[存档](https://web.archive.org/web/20211018025640/https://en.wikipedia.org/wiki/2%E2%80%933%E2%80%934_tree)]</sup>）的变体。[^gilbas1978]
...
???+ note
    ...
    部分资料中还加入了第五条性质，即根节点必须为黑色，这条性质要求完成插入操作后若根节点为红色则将其染黑，但由于将根节点染黑的操作也可以延迟至删除操作时进行，因此，该条性质并非必须满足（本文给出的代码实现中满足该性质）。为严谨起见，这里同时引用 [维基百科原文](https://en.wikipedia.org/wiki/Red%E2%80%93black_tree#Properties)<sup>[[存档](https://web.archive.org/web/20241231181959/https://en.wikipedia.org/wiki/Red%E2%80%93black_tree#Properties)]</sup> 进行说明：
...
- [`linux/lib/rbtree.c`](https://elixir.bootlin.com/linux/latest/source/lib/rbtree.c)<sup>[[存档](https://web.archive.org/web/20250525053550/https://elixir.bootlin.com/linux/latest/source/lib/rbtree.c)]</sup>

Linux 中的红黑树所有操作均使用循环迭代进行实现，保证效率的同时又增加了大量的注释来保证代码可读性，十分建议读者阅读学习。Linux 内核中的红黑树使用非常广泛，这里仅列举几个经典案例。


- [CFS 非实时任务调度](https://www.kernel.org/doc/html/latest/scheduler/sched-design-CFS.html)<sup>[[存档](https://web.archive.org/web/20241223084650/https://www.kernel.org/doc/html/latest/scheduler/sched-design-CFS.html)]</sup>
...
- [epoll](https://man7.org/linux/man-pages/man7/epoll.7.html)<sup>[[存档](https://web.archive.org/web/20221225084210/https://man7.org/linux/man-pages/man7/epoll.7.html)]</sup>
...
- [`nginx/src/core/ngx_rbtree.c`](https://github.com/nginx/nginx/blob/master/src/core/ngx_rbtree.c)<sup>[[存档](https://web.archive.org/web/20221206021130/https://github.com/nginx/nginx/blob/master/src/core/ngx_rbtree.c)]</sup>
...
- GNU libstdc++
  ...
  - [`libstdc++-v3/include/bits/stl_tree.h`](https://github.com/gcc-mirror/gcc/blob/master/libstdc%2B%2B-v3/include/bits/stl_tree.h)<sup>[[存档](https://web.archive.org/web/20240415110410/https://github.com/gcc-mirror/gcc/blob/master/libstdc%2B%2B-v3/include/bits/stl_tree.h)]</sup>
  - [`libstdc++-v3/src/c++98/tree.cc`](https://github.com/gcc-mirror/gcc/blob/master/libstdc%2B%2B-v3/src/c%2B%2B98/tree.cc)<sup>[[存档](https://web.archive.org/web/20240421135009/https://github.com/gcc-mirror/gcc/blob/master/libstdc%2B%2B-v3/src/c%2B%2B98/tree.cc)]</sup>
...
- LLVM libcxx
  ...
  - [`libcxx/include/__tree`](https://github.com/llvm/llvm-project/blob/main/libcxx/include/__tree)<sup>[[存档](https://web.archive.org/web/20221026131013/https://github.com/llvm/llvm-project/blob/main/libcxx/include/__tree)]</sup>

- Microsoft STL

  - [`stl/inc/xtree`](https://github.com/microsoft/STL/blob/main/stl/inc/xtree)<sup>[[存档](https://web.archive.org/web/20240208234904/https://github.com/microsoft/STL/blob/main/stl/inc/xtree)]</sup>
...
- [`java.util.TreeMap<K, V>`](https://github.com/openjdk/jdk/blob/master/src/java.base/share/classes/java/util/TreeMap.java)<sup>[[存档](https://web.archive.org/web/20240418020450/https://github.com/openjdk/jdk/blob/master/src/java.base/share/classes/java/util/TreeMap.java)]</sup>
- [`java.util.TreeSet<K, V>`](https://github.com/openjdk/jdk/blob/master/src/java.base/share/classes/java/util/TreeSet.java)<sup>[[存档](https://web.archive.org/web/20250607061805/https://github.com/openjdk/jdk/blob/master/src/java.base/share/classes/java/util/TreeSet.java)]</sup>
- [`java.util.HashMap<K, V>`](https://github.com/openjdk/jdk/blob/master/src/java.base/share/classes/java/util/HashMap.java)<sup>[[存档](https://web.archive.org/web/20241222051113/https://github.com/openjdk/jdk/blob/master/src/java.base/share/classes/java/util/HashMap.java)]</sup>
...
- [Red-Black Tree - Wikipedia](https://en.wikipedia.org/wiki/Red%E2%80%93black_tree)<sup>[[存档](https://web.archive.org/web/20231229073515/https://en.wikipedia.org/wiki/Red%E2%80%93black_tree)]</sup>
- [Red-Black Tree Visualization](https://www.cs.usfca.edu/~galles/visualization/RedBlack.html)<sup>[[存档](https://web.archive.org/web/20231229091836/https://www.cs.usfca.edu/~galles/visualization/RedBlack.html)]</sup>

[^gilbas1978]: L. J. Guibas and R. Sedgewick, "A dichromatic framework for balanced trees,"*19th Annual Symposium on Foundations of Computer Science (sfcs 1978)*, Ann Arbor, MI, USA, 1978, pp. 8-21, doi:[10.1109/SFCS.1978.3](https://doi.org/10.1109%2FSFCS.1978.3)<sup>[[存档](https://web.archive.org/web/20230210105104/https://doi.org/10.1109%2FSFCS.1978.3)]</sup>.
[^234-vs-rbt]: [这篇博文](https://www.cnblogs.com/zhenbianshu/p/8185345.html)<sup>[[存档](https://web.archive.org/web/20221231173829/https://www.cnblogs.com/zhenbianshu/p/8185345.html)]</sup> 提供了详细的描述。
