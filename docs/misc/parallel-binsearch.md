...
下面提供 [【模板】可持久化线段树 2](https://www.luogu.com.cn/problem/P3834)<sup>[[存档](https://web.archive.org/web/20210301160251/https://www.luogu.com.cn/problem/P3834)]</sup> 一题使用整体二分的，偏向竞赛风格的写法。
...
> **题 4**  [Dynamic Rankings](https://pintia.cn/problem-sets/91827364500/exam/problems/91827365611)<sup>[[存档](https://web.archive.org/web/20240530084047/https://pintia.cn/problem-sets/91827364500/exam/problems/91827365611)]</sup> 给定一个数列，要支持单点修改，区间查第 $k$ 小。
...
> **题 5**  [【模板】可持久化线段树 2](https://www.luogu.com.cn/problem/P3834)<sup>[[存档](https://web.archive.org/web/20210301160251/https://www.luogu.com.cn/problem/P3834)]</sup> 给定一个序列，区间查询第 $k$ 小。
...
考虑使用整体二分解决这个问题：整体二分是一种高效求解区间第 $k$ 小的离线算法，而 [CDQ 分治](https://oi-wiki.org/misc/cdq-divide/)<sup>[[存档](https://web.archive.org/web/20190714112422/https://oi-wiki.org/misc/cdq-divide/)]</sup> 可以离线高效求解区间内的排名。先跑一遍 CDQ 分治求出排名就可以使用整体二分得到区间内部的前驱和后继了。
...
> **题 7**  [Sequence](https://www.luogu.com.cn/problem/P4597)<sup>[[存档](https://web.archive.org/web/20250717125958/https://www.luogu.com.cn/problem/P4597)]</sup> 给定一个序列，每次操作可以把某个数 $+1$ 或 $−1$。要求把序列变成单调不降的，并且修改后的数列只能出现修改前的数，输出最小操作次数。
...
[「国家集训队」矩阵乘法](https://www.luogu.com.cn/problem/P1527)<sup>[[存档](https://web.archive.org/web/20241205013511/https://www.luogu.com.cn/problem/P1527)]</sup>


[「POI2011 R3 Day2」流星 Meteors](https://loj.ac/p/2169)<sup>[[存档](https://web.archive.org/web/20240222215150/https://loj.ac/p/2169)]</sup>


[二逼平衡树](https://loj.ac/p/106)<sup>[[存档](https://web.archive.org/web/20231225135353/https://loj.ac/p/106)]</sup>


[[BalticOI 2004] Sequence 数字序列](https://www.luogu.com.cn/problem/P4331)<sup>[[存档](https://web.archive.org/web/20250815193745/https://www.luogu.com.cn/problem/P4331)]</sup>
