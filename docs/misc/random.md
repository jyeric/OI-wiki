...
- 某些随机算法（例如 [Moser 算法](https://en.wikipedia.org/wiki/Algorithmic_Lov%C3%A1sz_local_lemma)<sup>[[存档](https://web.archive.org/web/20250906085658/https://en.wikipedia.org/wiki/Algorithmic_Lov%C3%A1sz_local_lemma)]</sup>）用到了随机数的熵相关的性质，因此必须使用真正的随机数。
...
下面是用 `rand()` 及 `random_shuffle()` 编写的一个数据生成器。生成数据为 [「ZJOI2012」灾难](https://www.luogu.com.cn/problem/P2597)<sup>[[存档](https://web.archive.org/web/20220818021813/https://www.luogu.com.cn/problem/P2597)]</sup> 的随机小数据。
...
这里介绍的是要求生成的随机数按照一定的概率出现，如等概率，[伯努利分布](https://en.wikipedia.org/wiki/Bernoulli_distribution)<sup>[[存档](https://web.archive.org/web/20250907013128/https://en.wikipedia.org/wiki/Bernoulli_distribution)]</sup>，[二项分布](https://en.wikipedia.org/wiki/Binomial_distribution)<sup>[[存档](https://web.archive.org/web/20241227052002/https://en.wikipedia.org/wiki/Binomial_distribution)]</sup>，[几何分布](https://en.wikipedia.org/wiki/Geometric_distribution)<sup>[[存档](https://web.archive.org/web/20201228024157/https://en.wikipedia.org/wiki/Geometric_distribution)]</sup>，[标准正态（高斯）分布](https://en.wikipedia.org/wiki/Normal_distribution)<sup>[[存档](https://web.archive.org/web/20241231132104/https://en.wikipedia.org/wiki/Normal_distribution)]</sup>。


具体类名请参见 [伪随机数生成——随机数分布](https://zh.cppreference.com/w/cpp/numeric/random#.E9.9A.8F.E6.9C.BA.E6.95.B0.E5.88.86.E5.B8.83)<sup>[[存档](https://web.archive.org/web/20220601072730/https://zh.cppreference.com/w/cpp/numeric/random#.E9.9A.8F.E6.9C.BA.E6.95.B0.E5.88.86.E5.B8.83)]</sup> 的列表。
...
[^ref2]: [伪随机数生成 - cppreference.com](https://zh.cppreference.com/w/cpp/numeric/random#%E9%A2%84%E5%AE%9A%E4%B9%89%E9%9A%8F%E6%9C%BA%E6%95%B0%E7%94%9F%E6%88%90%E5%99%A8)<sup>[[存档](https://web.archive.org/web/20220601072730/https://zh.cppreference.com/w/cpp/numeric/random#%E9%A2%84%E5%AE%9A%E4%B9%89%E9%9A%8F%E6%9C%BA%E6%95%B0%E7%94%9F%E6%88%90%E5%99%A8)]</sup>
[^ref3]: [Mersenne Twister algorithm](https://en.wikipedia.org/wiki/Mersenne_Twister)<sup>[[存档](https://web.archive.org/web/20221222011000/https://en.wikipedia.org/wiki/Mersenne_Twister)]</sup>
[^note1]: 版本号为 GCC 9.2.0
[^ref1]: [Don't use rand(): a guide to random number generators in C++](https://codeforces.com/blog/entry/61587)<sup>[[存档](https://web.archive.org/web/20221221033419/https://codeforces.com/blog/entry/61587)]</sup>
