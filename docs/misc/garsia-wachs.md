...
函数性编程语言 Haskell 的 [garsia-wachs package](https://hackage.haskell.org/package/garsia-wachs)<sup>[[存档](https://web.archive.org/web/20231205042830/https://hackage.haskell.org/package/garsia-wachs)]</sup> 对 Garsia–Wachs 算法做了函数性实现。它主要用于构建最佳搜索表，或者以最优复杂度平衡 [rope](https://hackage.haskell.org/package/rope)<sup>[[存档](https://web.archive.org/web/20181017165243/https://hackage.haskell.org/package/rope)]</sup> 数据结构。
...
1. [Garsia–Wachs algorithm - Wikipedia](https://en.wikipedia.org/wiki/Garsia%E2%80%93Wachs_algorithm)<sup>[[存档](https://web.archive.org/web/20230314194754/https://en.wikipedia.org/wiki/Garsia%E2%80%93Wachs_algorithm)]</sup>
2. [Data.Algorithm.GarsiaWachs - Hackage Haskell](https://hackage.haskell.org/package/garsia-wachs-1.2/docs/Data-Algorithm-GarsiaWachs.html)<sup>[[存档](https://web.archive.org/web/20150914235205/https://hackage.haskell.org/package/garsia-wachs-1.2/docs/Data-Algorithm-GarsiaWachs.html)]</sup>
3. [garsia-wachs: A Functional Implementation of the Garsia-Wachs Algorithm](https://hackage.haskell.org/package/garsia-wachs)<sup>[[存档](https://web.archive.org/web/20231205042830/https://hackage.haskell.org/package/garsia-wachs)]</sup>
4. [Sentinel value - Wikipedia](https://en.wikipedia.org/wiki/Sentinel_value)<sup>[[存档](https://web.archive.org/web/20190927110410/https://en.wikipedia.org/wiki/Sentinel_value)]</sup>
5. [A new proof of the Garsia-Wachs algorithm](https://www.sciencedirect.com/science/article/abs/pii/0196677488900090)<sup>[[存档](https://web.archive.org/web/20240416084901/https://www.sciencedirect.com/science/article/abs/pii/0196677488900090)]</sup>
