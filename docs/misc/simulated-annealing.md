...
引用一张 [Simulated annealing - Wikipedia](https://en.wikipedia.org/wiki/Simulated_annealing)<sup>[[存档](https://web.archive.org/web/20171215161056/https://en.wikipedia.org/wiki/Simulated_annealing)]</sup> 的图片（随着温度的降低，跳跃越来越不随机，最优解也越来越稳定）。
...
此处代码以 [「BZOJ 3680」吊打 XXX](https://www.luogu.com.cn/problem/P1337)<sup>[[存档](https://web.archive.org/web/20221014111612/https://www.luogu.com.cn/problem/P1337)]</sup>（求 $n$ 个点的带权类费马点）为例。
...
- [「BZOJ 3680」吊打 XXX](https://www.luogu.com.cn/problem/P1337)<sup>[[存档](https://web.archive.org/web/20221014111612/https://www.luogu.com.cn/problem/P1337)]</sup>
- [「JSOI 2016」炸弹攻击](https://loj.ac/problem/2076)<sup>[[存档](https://web.archive.org/web/20200922192655/https://loj.ac/problem/2076)]</sup>
- [「HAOI 2006」均分数据](https://www.luogu.com.cn/problem/P2503)<sup>[[存档](https://web.archive.org/web/20231006021513/https://www.luogu.com.cn/problem/P2503)]</sup>
