...
珂朵莉树（Chtholly Tree），又名老司机树 ODT（Old Driver Tree）。起源自 [CF896C](https://codeforces.com/problemset/problem/896/C)<sup>[[存档](https://web.archive.org/web/20211028023538/https://codeforces.com/problemset/problem/896/C)]</sup>。
...
如果要保证复杂度正确，必须保证数据随机。详见 [Codeforces 上关于珂朵莉树的复杂度的证明](http://codeforces.com/blog/entry/56135?#comment-398940)<sup>[[存档](https://web.archive.org/web/20181226152426/http://codeforces.com/blog/entry/56135?#comment-398940)]</sup>。更详细的严格证明见 [珂朵莉树的复杂度分析](https://zhuanlan.zhihu.com/p/102786071)<sup>[[存档](https://web.archive.org/web/20220701145421/https://zhuanlan.zhihu.com/p/102786071)]</sup>。证明的结论是：用 `std::set` 实现的珂朵莉树的复杂度为 $O(n \log \log n)$，而用链表实现的复杂度为 $O(n \log n)$。


## 习题


- [「Luogu 1840」Color the Axis](https://www.luogu.com.cn/problem/P1840)<sup>[[存档](https://web.archive.org/web/20231005071210/https://www.luogu.com.cn/problem/P1840)]</sup>
- ~~[「SCOI2010」序列操作](https://www.luogu.com.cn/problem/P2572)<sup>[[存档](https://web.archive.org/web/20211127015151/https://www.luogu.com.cn/problem/P2572)]</sup>~~（该题目来源已添加 Hack 数据）
- [「SHOI2015」脑洞治疗仪](https://loj.ac/problem/2037)<sup>[[存档](https://web.archive.org/web/20220601072729/https://loj.ac/problem/2037)]</sup>
- [「Luogu 4979」矿洞：坍塌](https://www.luogu.com.cn/problem/P4979)<sup>[[存档](https://web.archive.org/web/20221129201136/https://www.luogu.com.cn/problem/P4979)]</sup>
- [「Luogu 8146」risrqnis](https://www.luogu.com.cn/problem/P8146)<sup>[[存档](https://web.archive.org/web/20250421020349/https://www.luogu.com.cn/problem/P8146)]</sup>

## 扩展阅读


[ODT 的映射思想的推广 - 洛谷专栏 (luogu.com.cn)](https://www.luogu.com.cn/article/0mys9qkh)<sup>[[存档](https://web.archive.org/web/20241213055625/https://www.luogu.com.cn/article/0mys9qkh)]</sup>


## 参考资料和注释


- [Problem - 896C - Codeforces](https://codeforces.com/problemset/problem/896/C)<sup>[[存档](https://web.archive.org/web/20211028023538/https://codeforces.com/problemset/problem/896/C)]</sup>（珂朵莉树的起源）
- [CF896C Willem, Chtholly and Seniorious 题解 - 洛谷专栏 (luogu.com.cn)](https://www.luogu.com.cn/article/gyxbe23s)<sup>[[存档](https://web.archive.org/web/20241213070118/https://www.luogu.com.cn/article/gyxbe23s)]</sup>（`std::set` 实现参考）
- [珂朵莉树的 map 实现 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/469794466)（`std::map` 实现参考）
- [题解 CF896C【Willem, Chtholly and Seniorious】- 洛谷专栏 (luogu.com.cn)](https://www.luogu.com.cn/article/umiw1fwp)<sup>[[存档](https://web.archive.org/web/20250421022241/https://www.luogu.com.cn/article/umiw1fwp)]</sup>（链表实现参考）
- [Codeforces Round #449 Editorial - Codeforces](https://codeforces.com/blog/entry/56135?#comment-398940)<sup>[[存档](https://web.archive.org/web/20191226151207/https://codeforces.com/blog/entry/56135?#comment-398940)]</sup>（关于珂朵莉树的复杂度的证明）
- [珂朵莉树的复杂度分析 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/102786071)<sup>[[存档](https://web.archive.org/web/20220701145421/https://zhuanlan.zhihu.com/p/102786071)]</sup>（珂朵莉树的复杂度分析）
