...
[leetcode 15. 三数之和](https://leetcode-cn.com/problems/3sum/)<sup>[[存档](https://web.archive.org/web/20220712225840/https://leetcode-cn.com/problems/3sum/)]</sup>


[leetcode 1438. 绝对差不超过限制的最长连续子数组](https://leetcode-cn.com/problems/longest-continuous-subarray-with-absolute-diff-less-than-or-equal-to-limit/)<sup>[[存档](https://web.archive.org/web/20250905121153/https://leetcode-cn.com/problems/longest-continuous-subarray-with-absolute-diff-less-than-or-equal-to-limit/)]</sup>
