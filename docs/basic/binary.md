...
C++ 标准库中实现了查找首个不小于给定值的元素的函数 [`std::lower_bound`](https://zh.cppreference.com/w/cpp/algorithm/lower_bound)<sup>[[存档](https://web.archive.org/web/20241231195950/https://zh.cppreference.com/w/cpp/algorithm/lower_bound)]</sup> 和查找首个大于给定值的元素的函数 [`std::upper_bound`](https://zh.cppreference.com/w/cpp/algorithm/upper_bound)<sup>[[存档](https://web.archive.org/web/20241231195948/https://zh.cppreference.com/w/cpp/algorithm/upper_bound)]</sup>，二者均定义于头文件 `<algorithm>` 中。
...
- [UOJ 162 -【清华集训 2015】灯泡测试](https://uoj.ac/problem/162)<sup>[[存档](https://web.archive.org/web/20250422132057/https://uoj.ac/problem/162)]</sup>
- [洛谷 P7579 -「RdOI R2」称重（weigh）](https://www.luogu.com.cn/problem/P7579)<sup>[[存档](https://web.archive.org/web/20241231195936/https://www.luogu.com.cn/problem/P7579)]</sup>
...
- [Ternary search - Wikipedia](https://en.wikipedia.org/wiki/Ternary_search)<sup>[[存档](https://web.archive.org/web/20191225200601/https://en.wikipedia.org/wiki/Ternary_search)]</sup>
- [Golden-section search - Wikipedia](https://en.wikipedia.org/wiki/Golden-section_search)<sup>[[存档](https://web.archive.org/web/20241210032703/https://en.wikipedia.org/wiki/Golden-section_search)]</sup>
- [Ternary search - CP Algortihms](https://cp-algorithms.com/num_methods/ternary_search.html)<sup>[[存档](https://web.archive.org/web/20220927211247/https://cp-algorithms.com/num_methods/ternary_search.html)]</sup>
