...
归并排序（[merge sort](https://en.wikipedia.org/wiki/Merge_sort)<sup>[[存档](https://web.archive.org/web/20231227210416/https://en.wikipedia.org/wiki/Merge_sort)]</sup>）是高效的基于比较的稳定排序算法。
...
排序后的数组无逆序对。归并排序的合并操作中，每次后段首元素被作为当前最小值取出时，前段剩余元素个数之和即是合并操作减少的逆序对数量；故归并排序计算逆序对数量的时间复杂度为 $\Theta (n \log n)$。此外，逆序对计数还可以通过树状数组或线段树解决，时间复杂度也是 $O(n \log n)$；这一算法的详细解释参见 [树状数组](../ds/fenwick.md#%E5%85%A8%E5%B1%80%E9%80%86%E5%BA%8F%E5%AF%B9%E5%85%A8%E5%B1%80%E4%BA%8C%E7%BB%B4%E5%81%8F%E5%BA%8F) 相应描述。两种算法的参考实现都在 [逆序对](../math/permutation.md#%E9%80%86%E5%BA%8F%E6%95%B0) 章节。


## 外部链接


- [Merge Sort - GeeksforGeeks](https://www.geeksforgeeks.org/merge-sort/)<sup>[[存档](https://web.archive.org/web/20211228221755/https://www.geeksforgeeks.org/merge-sort/)]</sup>
- [归并排序 - 维基百科，自由的百科全书](https://zh.wikipedia.org/wiki/%E5%BD%92%E5%B9%B6%E6%8E%92%E5%BA%8F)<sup>[[存档](https://web.archive.org/web/20171110062718/https://zh.wikipedia.org/wiki/%E5%BD%92%E5%B9%B6%E6%8E%92%E5%BA%8F)]</sup>
- [逆序对 - 维基百科，自由的百科全书](https://zh.wikipedia.org/wiki/%E9%80%86%E5%BA%8F%E5%AF%B9)<sup>[[存档](https://web.archive.org/web/20250101080900/https://zh.wikipedia.org/wiki/%E9%80%86%E5%BA%8F%E5%AF%B9)]</sup>
