...
C++ 标准库中实现了前缀和函数 [`std::partial_sum`](https://zh.cppreference.com/w/cpp/algorithm/partial_sum)<sup>[[存档](https://web.archive.org/web/20220621145146/https://zh.cppreference.com/w/cpp/algorithm/partial_sum)]</sup>，定义于头文件 `<numeric>` 中。从 C++17 开始，标准库还提供了一个功能相同的前缀和函数 [`std::inclusive_scan`](https://zh.cppreference.com/w/cpp/algorithm/inclusive_scan)<sup>[[存档](https://web.archive.org/web/20250122034811/https://zh.cppreference.com/w/cpp/algorithm/inclusive_scan)]</sup>，同样定义于头文件 `<numeric>` 中。
...
$$
S_{i_1,\cdots,i_k} = \sum_{i'*1\le i_1}\cdots\sum*{i'*k\le i_k} A*{i'_1,\cdots,i'_k}.
$$
...
C++ 标准库中实现了差分函数 [`std::adjacent_difference`](https://zh.cppreference.com/w/cpp/algorithm/adjacent_difference)<sup>[[存档](https://web.archive.org/web/20171124134025/https://zh.cppreference.com/w/cpp/algorithm/adjacent_difference)]</sup>，定义于头文件 `<numeric>` 中。
...
- [洛谷 B3612【深进 1. 例 1】求区间和](https://www.luogu.com.cn/problem/B3612)<sup>[[存档](https://web.archive.org/web/20241113024152/https://www.luogu.com.cn/problem/B3612)]</sup>
- [洛谷 U69096 前缀和的逆](https://www.luogu.com.cn/problem/U69096)<sup>[[存档](https://web.archive.org/web/20241231195800/https://www.luogu.com.cn/problem/U69096)]</sup>
- [AtCoder joi2007ho_a 最大の和](https://atcoder.jp/contests/joi2007ho/tasks/joi2007ho_a)<sup>[[存档](https://web.archive.org/web/20250719154327/https://atcoder.jp/contests/joi2007ho/tasks/joi2007ho_a)]</sup>
- [「USACO16JAN」子共七 Subsequences Summing to Sevens](https://www.luogu.com.cn/problem/P3131)<sup>[[存档](https://web.archive.org/web/20250905064742/https://www.luogu.com.cn/problem/P3131)]</sup>
- [「USACO05JAN」Moo Volume S](https://www.luogu.com.cn/problem/P6067)<sup>[[存档](https://web.archive.org/web/20241231195806/https://www.luogu.com.cn/problem/P6067)]</sup>

二维/多维前缀和：


- [HDU 6514 Monitor](https://acm.hdu.edu.cn/showproblem.php?pid=6514)<sup>[[存档](https://web.archive.org/web/20240707112323/https://acm.hdu.edu.cn/showproblem.php?pid=6514)]</sup>
- [洛谷 P1387 最大正方形](https://www.luogu.com.cn/problem/P1387)<sup>[[存档](https://web.archive.org/web/20241231195758/https://www.luogu.com.cn/problem/P1387)]</sup>
- [「HNOI2003」激光炸弹](https://www.luogu.com.cn/problem/P2280)<sup>[[存档](https://web.archive.org/web/20210416115719/https://www.luogu.com.cn/problem/P2280)]</sup>
- [CF 165E Compatible Numbers](https://codeforces.com/contest/165/problem/E)<sup>[[存档](https://web.archive.org/web/20120515182014/https://codeforces.com/contest/165/problem/E)]</sup>
- [CF 383E Vowels](https://codeforces.com/problemset/problem/383/E)<sup>[[存档](https://web.archive.org/web/20221217220504/https://codeforces.com/problemset/problem/383/E)]</sup>
- [ARC 100C Or Plus Max](https://atcoder.jp/contests/arc100/tasks/arc100_c)<sup>[[存档](https://web.archive.org/web/20250212071923/https://atcoder.jp/contests/arc100/tasks/arc100_c)]</sup>

树上前缀和：


- [LOJ 10134.Dis](https://loj.ac/problem/10134)<sup>[[存档](https://web.archive.org/web/20241231195759/https://loj.ac/problem/10134)]</sup>
- [LOJ 2491. 求和](https://loj.ac/problem/2491)<sup>[[存档](https://web.archive.org/web/20241231195814/https://loj.ac/problem/2491)]</sup>

差分：


- [树状数组 3：区间修改，区间查询](https://loj.ac/problem/132)<sup>[[存档](https://web.archive.org/web/20191127075303/https://loj.ac/problem/132)]</sup>
- [「Poetize6」IncDec Sequence](https://www.luogu.com.cn/problem/P4552)<sup>[[存档](https://web.archive.org/web/20250829101229/https://www.luogu.com.cn/problem/P4552)]</sup>
- [洛谷 P4231 三步必杀](https://www.luogu.com.cn/problem/P4231)<sup>[[存档](https://web.archive.org/web/20231009064905/https://www.luogu.com.cn/problem/P4231)]</sup>

二维/多维差分：


- [洛谷 P3397 地毯](https://www.luogu.com.cn/problem/P3397)<sup>[[存档](https://web.archive.org/web/20231008080233/https://www.luogu.com.cn/problem/P3397)]</sup>
- [洛谷 P8228「Wdoi-5」模块化核熔炉](https://www.luogu.com.cn/problem/P8228)<sup>[[存档](https://web.archive.org/web/20240813035305/https://www.luogu.com.cn/problem/P8228)]</sup>

树上差分：


- [洛谷 3128 最大流](https://www.luogu.com.cn/problem/P3128)<sup>[[存档](https://web.archive.org/web/20241231195757/https://www.luogu.com.cn/problem/P3128)]</sup>
- [JLOI2014 松鼠的新家](https://loj.ac/problem/2236)<sup>[[存档](https://web.archive.org/web/20250319102837/https://loj.ac/problem/2236)]</sup>
- [NOIP2015 运输计划](http://uoj.ac/problem/150)<sup>[[存档](https://web.archive.org/web/20241231195810/http://uoj.ac/problem/150)]</sup>
- [NOIP2016 天天爱跑步](http://uoj.ac/problem/261)<sup>[[存档](https://web.archive.org/web/20241231195817/http://uoj.ac/problem/261)]</sup>
