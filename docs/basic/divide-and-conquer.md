...
- [LeetCode 上的递归专题练习](https://leetcode.com/explore/learn/card/recursion-i/)<sup>[[存档](https://web.archive.org/web/20230604002948/https://leetcode.com/explore/learn/card/recursion-i/)]</sup>
- [LeetCode 上的分治算法专项练习](https://leetcode.com/tag/divide-and-conquer/)<sup>[[存档](https://web.archive.org/web/20181231140323/https://leetcode.com/tag/divide-and-conquer/)]</sup>

## 参考资料与注释

[^ref1]: [labuladong 的算法小抄 - 递归详解](https://labuladong.gitbook.io/algo/suan-fa-si-wei-xi-lie/di-gui-xiang-jie)<sup>[[存档](https://web.archive.org/web/20241225150000/https://labuladong.gitbook.io/algo/suan-fa-si-wei-xi-lie/di-gui-xiang-jie)]</sup>
