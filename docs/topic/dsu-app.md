...
**本页面部分内容译自博文 [Поиск мостов в режиме онлайн](http://e-maxx.ru/algo/bridge_searching_online)<sup>[[存档](https://web.archive.org/web/20200627020231/http://e-maxx.ru/algo/bridge_searching_online)]</sup> 与其英文翻译版 [Finding Bridges Online](https://cp-algorithms.com/graph/bridge-searching-online.html)<sup>[[存档](https://web.archive.org/web/20250810225558/https://cp-algorithms.com/graph/bridge-searching-online.html)]</sup>。其中俄文版版权协议为 Public Domain + Leave a Link；英文版版权协议为 CC-BY-SA 4.0。**
