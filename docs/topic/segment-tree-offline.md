...
- [CF601E A Museum Robbery](https://codeforces.com/problemset/problem/601/E)<sup>[[存档](https://web.archive.org/web/20250323142217/https://codeforces.com/problemset/problem/601/E)]</sup> 线段树分治 + 背包 dp。
- [CF19E Fairy](https://codeforces.com/problemset/problem/19/E)<sup>[[存档](https://web.archive.org/web/20240425151755/https://codeforces.com/problemset/problem/19/E)]</sup> 线段树分治 + 种类并查集。
- [luogu P5227 [AHOI2013] 连通图](https://www.luogu.com.cn/problem/P5227)<sup>[[存档](https://web.archive.org/web/20241210012127/https://www.luogu.com.cn/problem/P5227)]</sup> 线段树分治 + 并查集。
- [luogu P4319 变化的道路](https://www.luogu.com.cn/problem/P4319)<sup>[[存档](https://web.archive.org/web/20231009074300/https://www.luogu.com.cn/problem/P4319)]</sup> 线段树分治 + Link Cut Tree 维护最小生成树。
- [luogu P3733 [HAOI2017] 八纵八横](https://www.luogu.com.cn/problem/P3733)<sup>[[存档](https://web.archive.org/web/20250711093813/https://www.luogu.com.cn/problem/P3733)]</sup> 线段树分治 + 线性基。

**本页面部分内容参考自博文 [Deleting from a data structure](https://cp-algorithms.com/data_structures/deleting_in_log_n.html)<sup>[[存档](https://web.archive.org/web/20250810214745/https://cp-algorithms.com/data_structures/deleting_in_log_n.html)]</sup>，版权协议为 CC-BY-SA 4.0。**
